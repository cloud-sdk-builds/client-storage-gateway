...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i4aup5hpWHhWplmf1tw8NJxSABHe6l/aY7D5Ki1FhTcSIgrXHd99YGt/8RN1QaxT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.501.0/index.min.mjs": "sha384-i4aup5hpWHhWplmf1tw8NJxSABHe6l/aY7D5Ki1FhTcSIgrXHd99YGt/8RN1QaxT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.501.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-hIXE6edGnxcVjBdOTMUVgXWTlCSTQGlN1ZTgUPP3qJPXy3Ut0AI4MWrwyGegyUy0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.8.1/index.min.mjs": "sha384-hIXE6edGnxcVjBdOTMUVgXWTlCSTQGlN1ZTgUPP3qJPXy3Ut0AI4MWrwyGegyUy0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.8.1/LICENSE
```

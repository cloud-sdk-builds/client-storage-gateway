...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.681.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.681.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eTd/DuvSbLodMwVuDFDjsXW6K20U8aBN34CbTlQ/BsQS8UIb+LTrk1w4NE8ebS1V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.681.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.681.0/index.min.mjs": "sha384-eTd/DuvSbLodMwVuDFDjsXW6K20U8aBN34CbTlQ/BsQS8UIb+LTrk1w4NE8ebS1V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.681.0/LICENSE
```

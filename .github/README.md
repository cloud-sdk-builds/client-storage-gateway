...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cv5J3JsRArdJuPTX2A8vqPPB8KXlU8aeqt4/5ZvaYQu9WHkk9SyGXtNBjZFHwuYt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.67.0/index.min.mjs": "sha384-Cv5J3JsRArdJuPTX2A8vqPPB8KXlU8aeqt4/5ZvaYQu9WHkk9SyGXtNBjZFHwuYt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.67.0/LICENSE
```

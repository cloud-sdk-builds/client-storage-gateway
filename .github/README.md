...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RYQ1Cx1oKthtgkpBk+b13Riq6JI+ERO7T3eetuquhq4ThGHQQYSkog6RnqSk3zhl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.974.0/index.min.mjs": "sha384-RYQ1Cx1oKthtgkpBk+b13Riq6JI+ERO7T3eetuquhq4ThGHQQYSkog6RnqSk3zhl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.974.0/LICENSE
```

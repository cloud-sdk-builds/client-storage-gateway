...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OpTqQZ8xXX5RiJ+RGnJ1sFsFEB0qZYWTm5sT8ivV+p+YgIQbNQd5e0EZ/AweAbgM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.224.0/index.min.mjs": "sha384-OpTqQZ8xXX5RiJ+RGnJ1sFsFEB0qZYWTm5sT8ivV+p+YgIQbNQd5e0EZ/AweAbgM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.224.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qc+qcpiYVWEaFXaTEg7RcR8j0wp34nqnuPcF++DfD6DpqOYexlItgyeX6tp3f//p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.163.0/index.min.mjs": "sha384-qc+qcpiYVWEaFXaTEg7RcR8j0wp34nqnuPcF++DfD6DpqOYexlItgyeX6tp3f//p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.163.0/LICENSE
```

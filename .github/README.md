...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.883.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.883.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-17HEUCd0Vh1+0mGRuRNG2YGgNa8/amOXIywRg6es9orCHZsgdaLBT195DKg+Fqs2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.883.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.883.0/index.min.mjs": "sha384-17HEUCd0Vh1+0mGRuRNG2YGgNa8/amOXIywRg6es9orCHZsgdaLBT195DKg+Fqs2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.883.0/LICENSE
```

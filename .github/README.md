...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.418.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.418.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fGznuhkCn3tLiQbryU7oMtMnhnbpO0EU5Ti2quqSmrxoh+Df4aNIcr+5XEZVHwri
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.418.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.418.0/index.min.mjs": "sha384-fGznuhkCn3tLiQbryU7oMtMnhnbpO0EU5Ti2quqSmrxoh+Df4aNIcr+5XEZVHwri"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.418.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cs2lNpjbwevS0g5Rmw5VPvW9PSBr6E6AKiVeCtowKU4A9bEImGtaZbAUphMc2IyS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.79.0/index.min.mjs": "sha384-Cs2lNpjbwevS0g5Rmw5VPvW9PSBr6E6AKiVeCtowKU4A9bEImGtaZbAUphMc2IyS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.79.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.10.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.10.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+Yqo6ebbiI7yf6UOM5XSsXy8UCkLo2Fg91P8GlXSC7cPnaWD4IiLtTy1MCy7pFBh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.10.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.10.0/index.min.mjs": "sha384-+Yqo6ebbiI7yf6UOM5XSsXy8UCkLo2Fg91P8GlXSC7cPnaWD4IiLtTy1MCy7pFBh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.10.0/LICENSE
```

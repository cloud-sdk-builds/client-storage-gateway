...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ET5rcsrPVB7wj/5V6bcLuMxW+lHRHhx4BUtBENavNHzYNj2MGRNoYfH5PJwoGm4B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.816.0/index.min.mjs": "sha384-ET5rcsrPVB7wj/5V6bcLuMxW+lHRHhx4BUtBENavNHzYNj2MGRNoYfH5PJwoGm4B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.816.0/LICENSE
```

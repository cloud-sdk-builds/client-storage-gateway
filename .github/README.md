...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2EvwagXqSjGS1vo7Z83AnUQ38MIggYSKCTFspdIwPdVLWYTDgC8Jt7WA2LSVDXwE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.654.0/index.min.mjs": "sha384-2EvwagXqSjGS1vo7Z83AnUQ38MIggYSKCTFspdIwPdVLWYTDgC8Jt7WA2LSVDXwE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.654.0/LICENSE
```

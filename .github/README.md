...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SWr50IiH8n/tH2pfqHlXeiZh5hfoDBlWOMvsb/PH/NiJIAnljn3BYiT1g55xxecE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.932.0/index.min.mjs": "sha384-SWr50IiH8n/tH2pfqHlXeiZh5hfoDBlWOMvsb/PH/NiJIAnljn3BYiT1g55xxecE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.932.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GaFwxLTZNZfOBCeRbpOn/VYcXmuTcdg6RKXmn8Z7sIZ7aDAwDUWVj4GP5zXIPwuS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.385.0/index.min.mjs": "sha384-GaFwxLTZNZfOBCeRbpOn/VYcXmuTcdg6RKXmn8Z7sIZ7aDAwDUWVj4GP5zXIPwuS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.385.0/LICENSE
```

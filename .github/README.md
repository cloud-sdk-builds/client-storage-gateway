...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.509.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.509.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AN7pOgvkbvv+I9MQLKRKesXJhyVVECIicSZgGDOYczQ0LJrAjglfG+rzwGAD2J3W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.509.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.509.0/index.min.mjs": "sha384-AN7pOgvkbvv+I9MQLKRKesXJhyVVECIicSZgGDOYczQ0LJrAjglfG+rzwGAD2J3W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.509.0/LICENSE
```

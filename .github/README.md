...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I5rTGMY3RAG6WCZxG54cCxs6VZl2QwPKP2NzuLW/ampNGHFpVlgTxCYXxKy84foD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.629.0/index.min.mjs": "sha384-I5rTGMY3RAG6WCZxG54cCxs6VZl2QwPKP2NzuLW/ampNGHFpVlgTxCYXxKy84foD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.629.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.363.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.363.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mKWyYKRW/B55q5WzTYI8KfNFv6i6jtoqt+CTnzjTk/6U1u8NBR8SU3qSll7JWf+1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.363.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.363.0/index.min.mjs": "sha384-mKWyYKRW/B55q5WzTYI8KfNFv6i6jtoqt+CTnzjTk/6U1u8NBR8SU3qSll7JWf+1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.363.0/LICENSE
```

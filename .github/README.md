...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.840.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.840.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WpAGP22atIOaktWCn66Amg/iNQjHxxiXByBP2nzn6R18+/j71PizAqUL+GjbKJjD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.840.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.840.0/index.min.mjs": "sha384-WpAGP22atIOaktWCn66Amg/iNQjHxxiXByBP2nzn6R18+/j71PizAqUL+GjbKJjD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.840.0/LICENSE
```

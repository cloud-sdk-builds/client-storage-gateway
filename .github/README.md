...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bdhooQfHvvnNsxiTp7xbLhoOS9z9k7F0po4JCRxylMwV5weNE2+JhBKkLc77hzOn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.293.0/index.min.mjs": "sha384-bdhooQfHvvnNsxiTp7xbLhoOS9z9k7F0po4JCRxylMwV5weNE2+JhBKkLc77hzOn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.293.0/LICENSE
```

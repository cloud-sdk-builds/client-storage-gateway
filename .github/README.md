...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-reKfGqa2XZwX+8yKqoZwE7zdx8JMqPEcXXH2IEAFuaZjZ15SeR18daGOMvSWriEU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.303.0/index.min.mjs": "sha384-reKfGqa2XZwX+8yKqoZwE7zdx8JMqPEcXXH2IEAFuaZjZ15SeR18daGOMvSWriEU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.303.0/LICENSE
```

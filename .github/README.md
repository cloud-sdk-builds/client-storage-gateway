...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-gmi4fJ1UNBDeCuzGiuJbnJMpEtxehsbw0UoVb6mPQhcAuKKTQy46Wu1B13ehB4ld
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.47.2/index.min.mjs": "sha384-gmi4fJ1UNBDeCuzGiuJbnJMpEtxehsbw0UoVb6mPQhcAuKKTQy46Wu1B13ehB4ld"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.47.2/LICENSE
```

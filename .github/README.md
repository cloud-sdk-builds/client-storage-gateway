...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1018.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1018.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o8pEvhOtbMvKhx2/YYyFr+ToXMzAY7QXovJRwXPSNGGoxdDXlBBW+OWxcT+sIawU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1018.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1018.0/index.min.mjs": "sha384-o8pEvhOtbMvKhx2/YYyFr+ToXMzAY7QXovJRwXPSNGGoxdDXlBBW+OWxcT+sIawU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1018.0/LICENSE
```

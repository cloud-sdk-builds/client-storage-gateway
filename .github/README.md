...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MYjNc5CyUXymPQT9Hc+4JXC8Z9RYJX+1FNlA8wfEJT8OgyU6flnmKpOHWCOt4z+Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.975.0/index.min.mjs": "sha384-MYjNc5CyUXymPQT9Hc+4JXC8Z9RYJX+1FNlA8wfEJT8OgyU6flnmKpOHWCOt4z+Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.975.0/LICENSE
```

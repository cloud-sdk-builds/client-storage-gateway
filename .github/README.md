...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aGV+d95YKgOHGHSytxS8u3fGmpV9xFQAQUsyIwTQDc1MFKbFt11Fu5aSIfypsHHT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.378.0/index.min.mjs": "sha384-aGV+d95YKgOHGHSytxS8u3fGmpV9xFQAQUsyIwTQDc1MFKbFt11Fu5aSIfypsHHT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.378.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VA7hO7rVWnQmZEbcSi61RTBn8UWs9y6vskBT7gZS4LasCiLN8CcMRffBV+jNHpBF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.196.0/index.min.mjs": "sha384-VA7hO7rVWnQmZEbcSi61RTBn8UWs9y6vskBT7gZS4LasCiLN8CcMRffBV+jNHpBF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.196.0/LICENSE
```

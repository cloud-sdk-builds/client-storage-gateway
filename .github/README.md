...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M+kkBMN1eTLWNz9EZel9OV/M1ZmdDn26HcVonRXggRo7XqPSUOd/N9pAeCB5aU6K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.670.0/index.min.mjs": "sha384-M+kkBMN1eTLWNz9EZel9OV/M1ZmdDn26HcVonRXggRo7XqPSUOd/N9pAeCB5aU6K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.670.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zSuCjqDH3UrnSeTjtyX2oZKli9TzHuMwfUQCOa2dbIMYKfPGfCRqD2I0E9VrQQ+N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.967.0/index.min.mjs": "sha384-zSuCjqDH3UrnSeTjtyX2oZKli9TzHuMwfUQCOa2dbIMYKfPGfCRqD2I0E9VrQQ+N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.967.0/LICENSE
```

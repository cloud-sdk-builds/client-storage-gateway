...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Da6G5UzjKdm90q4L2mjwtz7ihTojk4JO9yjDbYF9FWWDuSv8OiFwwZDblgDoSEfe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.21.0/index.min.mjs": "sha384-Da6G5UzjKdm90q4L2mjwtz7ihTojk4JO9yjDbYF9FWWDuSv8OiFwwZDblgDoSEfe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.21.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iMT7s6pO3yeamfNSxdve9XScW2D695Ht/DYoUUdctSSthdcPB75AogVBXe2pRGop
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.996.0/index.min.mjs": "sha384-iMT7s6pO3yeamfNSxdve9XScW2D695Ht/DYoUUdctSSthdcPB75AogVBXe2pRGop"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.996.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IMreB8CdNvjiMpa7yuqQBGIpntZmP4p03RloX7CeNNH6UvxfxlcLo6OH2QGvEJVn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.33.0/index.min.mjs": "sha384-IMreB8CdNvjiMpa7yuqQBGIpntZmP4p03RloX7CeNNH6UvxfxlcLo6OH2QGvEJVn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.33.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z2PgYlAxyg20bERWo5dHznZh9gQ75j8+6iTJBoqQYxaGdVsIfKefV3HHjllIMqev
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.421.0/index.min.mjs": "sha384-z2PgYlAxyg20bERWo5dHznZh9gQ75j8+6iTJBoqQYxaGdVsIfKefV3HHjllIMqev"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.421.0/LICENSE
```

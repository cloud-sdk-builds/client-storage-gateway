...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XdhcX1MSX/L8zRW8ohnmZl7T/HKGV2vDSLMUGH1RjK+7Jd5kJZSiffoU6V70AIwf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.821.0/index.min.mjs": "sha384-XdhcX1MSX/L8zRW8ohnmZl7T/HKGV2vDSLMUGH1RjK+7Jd5kJZSiffoU6V70AIwf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.821.0/LICENSE
```

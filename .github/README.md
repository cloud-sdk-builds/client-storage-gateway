...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kWiLscUAK6j7HxBGydx9Un0AtCswtuPiAIMlk6aydJmJEfyH689DqLIHX7dytvhK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.997.0/index.min.mjs": "sha384-kWiLscUAK6j7HxBGydx9Un0AtCswtuPiAIMlk6aydJmJEfyH689DqLIHX7dytvhK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.997.0/LICENSE
```

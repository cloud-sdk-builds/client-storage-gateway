...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qZB7uBxEJPT9inuiwOYxAC1YAjVRF9C4XPPX/sIP34Fsoz/Yj1wu8Zv1PhTFU8fs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1036.0/index.min.mjs": "sha384-qZB7uBxEJPT9inuiwOYxAC1YAjVRF9C4XPPX/sIP34Fsoz/Yj1wu8Zv1PhTFU8fs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1036.0/LICENSE
```

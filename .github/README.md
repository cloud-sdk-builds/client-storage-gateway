...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.238.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.238.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OdYD8KRkMWlG9H8k9VaBbcG104FDYgrklEimkabB9qSwS1+EJZdnDLZyjpRu03zI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.238.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.238.0/index.min.mjs": "sha384-OdYD8KRkMWlG9H8k9VaBbcG104FDYgrklEimkabB9qSwS1+EJZdnDLZyjpRu03zI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.238.0/LICENSE
```

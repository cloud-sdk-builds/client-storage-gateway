...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.110.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.110.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mnplmjvbQlF0VXYuEz5aOAoUGErL6qUFBYo4Prm+UXcbkR8n0Cz8eNV4AL8WqwvO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.110.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.110.0/index.min.mjs": "sha384-mnplmjvbQlF0VXYuEz5aOAoUGErL6qUFBYo4Prm+UXcbkR8n0Cz8eNV4AL8WqwvO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.110.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IDGQ6iRSa9jUqyIC4ZiNLqGwn4vN+iQFg5gEOR5sNLbU5OhfP2kvnTDzqMEkVqUO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.982.0/index.min.mjs": "sha384-IDGQ6iRSa9jUqyIC4ZiNLqGwn4vN+iQFg5gEOR5sNLbU5OhfP2kvnTDzqMEkVqUO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.982.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DgJV1sSjBlO5iyGdLG1FjOp31oMPfBm5yCwfpAuC1lj6MNZtlIvqw05FjP1gr53k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.428.0/index.min.mjs": "sha384-DgJV1sSjBlO5iyGdLG1FjOp31oMPfBm5yCwfpAuC1lj6MNZtlIvqw05FjP1gr53k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.428.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yvqt4XLkYcm/2T4+wQMRqxTe5fLzszTh8NXkU+AebsUo4cTylsViF4oQLv9ktayw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.160.0/index.min.mjs": "sha384-yvqt4XLkYcm/2T4+wQMRqxTe5fLzszTh8NXkU+AebsUo4cTylsViF4oQLv9ktayw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.160.0/LICENSE
```

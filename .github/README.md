...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SSulcDoqQNXkohL5n0lO8wBE+AoeDNsMrNFSzNvrz/LdVcRb3JOoMc4NdLwsNRrc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.40.0/index.min.mjs": "sha384-SSulcDoqQNXkohL5n0lO8wBE+AoeDNsMrNFSzNvrz/LdVcRb3JOoMc4NdLwsNRrc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.40.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.165.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.165.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WIZ/2wbE0qscw7qJR/bNlbOMEulncd4CgmjnY4vjNEWyfNFlS/lNKpEnK536Jk+t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.165.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.165.0/index.min.mjs": "sha384-WIZ/2wbE0qscw7qJR/bNlbOMEulncd4CgmjnY4vjNEWyfNFlS/lNKpEnK536Jk+t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.165.0/LICENSE
```

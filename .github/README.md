...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nHoU+j5JCAmtKD9LToRp68OY2ZbjovwOrV7h87K5NDAVEgdLlG7E1i21d3p2SPbM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.523.0/index.min.mjs": "sha384-nHoU+j5JCAmtKD9LToRp68OY2ZbjovwOrV7h87K5NDAVEgdLlG7E1i21d3p2SPbM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.523.0/LICENSE
```

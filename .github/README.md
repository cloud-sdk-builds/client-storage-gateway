...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hy76i2f5YOjmhZjOopOPQCXVQ+y4b7FO40FnEbGcjs1dUjTTtED2QqUS6WO2jFRt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.298.0/index.min.mjs": "sha384-hy76i2f5YOjmhZjOopOPQCXVQ+y4b7FO40FnEbGcjs1dUjTTtED2QqUS6WO2jFRt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.298.0/LICENSE
```

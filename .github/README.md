...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.748.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.748.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+GhuA37FZ3GGrJD2T1h3iXk/3iCAbZfCkrAPvnfZUIqP/voeOE248GFJe31D7Ewz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.748.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.748.0/index.min.mjs": "sha384-+GhuA37FZ3GGrJD2T1h3iXk/3iCAbZfCkrAPvnfZUIqP/voeOE248GFJe31D7Ewz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.748.0/LICENSE
```

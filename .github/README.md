...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.87.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.87.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/+X/vQVTv58hbe/pALynJGlsbt243DMpoFSvKtVkX70ze/XtFWPpZZmH8yGO07Fr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.87.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.87.0/index.min.mjs": "sha384-/+X/vQVTv58hbe/pALynJGlsbt243DMpoFSvKtVkX70ze/XtFWPpZZmH8yGO07Fr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.87.0/LICENSE
```

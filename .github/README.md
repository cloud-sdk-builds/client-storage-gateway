...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.348.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.348.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S/1IMvoieLrNCH98hgZIR4WhimkMkKzZWtpoo6ylf39WWHmxT2eGn4I8y0NlhS/B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.348.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.348.0/index.min.mjs": "sha384-S/1IMvoieLrNCH98hgZIR4WhimkMkKzZWtpoo6ylf39WWHmxT2eGn4I8y0NlhS/B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.348.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZvNgplH1b+ET8hIwVuQJUKXsAc/twcLybzLmyByE07yOlmBC6zZmtkNl7Ps/bL2U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.218.0/index.min.mjs": "sha384-ZvNgplH1b+ET8hIwVuQJUKXsAc/twcLybzLmyByE07yOlmBC6zZmtkNl7Ps/bL2U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.218.0/LICENSE
```

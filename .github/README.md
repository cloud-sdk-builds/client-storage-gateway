...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6gE0iWPRBOpbfQD50z1zqlia65K/cDRyez3VFi4txZcZJ/1C0q3K8D9lVfmZWG7b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.34.0/index.min.mjs": "sha384-6gE0iWPRBOpbfQD50z1zqlia65K/cDRyez3VFi4txZcZJ/1C0q3K8D9lVfmZWG7b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.34.0/LICENSE
```

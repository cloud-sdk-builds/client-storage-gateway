...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pAcwSZwsnVlugeXDXAPZuDX5G49TbqASJVJfp73u+yfj/9i2aMlfVuLkkeNZ1+uG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.964.0/index.min.mjs": "sha384-pAcwSZwsnVlugeXDXAPZuDX5G49TbqASJVJfp73u+yfj/9i2aMlfVuLkkeNZ1+uG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.964.0/LICENSE
```

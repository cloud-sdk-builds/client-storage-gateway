...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G2hkyQ5P4ssOHgn1NmC7gY61VbhT9crbsH9jvizbrOwQ0QJTA2JL90smC1JgJ8fd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.777.0/index.min.mjs": "sha384-G2hkyQ5P4ssOHgn1NmC7gY61VbhT9crbsH9jvizbrOwQ0QJTA2JL90smC1JgJ8fd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.777.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z6+D5z8t7TXNEn0sUh4kf1daNAcLNLRaIWUVVbAxbelFjOojRuNa7pcyTw3Aby86
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.804.0/index.min.mjs": "sha384-Z6+D5z8t7TXNEn0sUh4kf1daNAcLNLRaIWUVVbAxbelFjOojRuNa7pcyTw3Aby86"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.804.0/LICENSE
```

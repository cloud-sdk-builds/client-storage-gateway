...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bMiJ2qKS0jxNOvAyEToqwW7z/FFGHagWKsumfV4w2PEzrz/6CRDw6AfX9tjY307w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.504.0/index.min.mjs": "sha384-bMiJ2qKS0jxNOvAyEToqwW7z/FFGHagWKsumfV4w2PEzrz/6CRDw6AfX9tjY307w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.504.0/LICENSE
```

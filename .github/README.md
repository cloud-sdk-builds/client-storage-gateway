...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jr3T9IDAoFqvEP803OYcebWIU8UAodAwYkYYa9dpfpMwTysW1pm6zt5zLCGFxILT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.844.0/index.min.mjs": "sha384-jr3T9IDAoFqvEP803OYcebWIU8UAodAwYkYYa9dpfpMwTysW1pm6zt5zLCGFxILT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.844.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.425.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.425.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W5XWxYuQvHUZEp5cPhoBjOeMFftXAvITyvvO6Z6rrfWk1E8vC8+JOxTexHHQHW43
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.425.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.425.0/index.min.mjs": "sha384-W5XWxYuQvHUZEp5cPhoBjOeMFftXAvITyvvO6Z6rrfWk1E8vC8+JOxTexHHQHW43"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.425.0/LICENSE
```

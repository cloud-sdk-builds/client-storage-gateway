...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-quKgrEOll0VVH3CMZFdWUMEUG7kIDUn6G8rEQZBPL7Wq4EDcUf2WZPf+gQSrQYiP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.980.0/index.min.mjs": "sha384-quKgrEOll0VVH3CMZFdWUMEUG7kIDUn6G8rEQZBPL7Wq4EDcUf2WZPf+gQSrQYiP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.980.0/LICENSE
```

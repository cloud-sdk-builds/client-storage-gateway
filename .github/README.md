...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.450.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.450.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2ULfACWSAki12AIjKneq2M853qsYAjFt1uFyetl4kRHMz3nm3YB+x/nLFZ4T22T0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.450.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.450.0/index.min.mjs": "sha384-2ULfACWSAki12AIjKneq2M853qsYAjFt1uFyetl4kRHMz3nm3YB+x/nLFZ4T22T0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.450.0/LICENSE
```

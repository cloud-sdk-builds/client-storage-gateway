...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z5H5O2XvbSxlDennpjybqGo3vztW7RwgJPMVCciprD5S6huV8qQf/s0ghucUpoiN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.391.0/index.min.mjs": "sha384-z5H5O2XvbSxlDennpjybqGo3vztW7RwgJPMVCciprD5S6huV8qQf/s0ghucUpoiN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.391.0/LICENSE
```

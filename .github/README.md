...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NVN/X/hjzSa+Dxpi3mD/LHm3tpmodBGS09F4xiCUd/osknxv5GWS3PtRB2tAsotI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.168.0/index.min.mjs": "sha384-NVN/X/hjzSa+Dxpi3mD/LHm3tpmodBGS09F4xiCUd/osknxv5GWS3PtRB2tAsotI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.168.0/LICENSE
```

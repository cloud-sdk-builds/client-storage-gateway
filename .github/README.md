...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1vUn4qFvh8wKXYCabmYOa//ko67mT/ANmYns/LoY4U/pd8V4s+r9+zcdIFXmLHO1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.686.0/index.min.mjs": "sha384-1vUn4qFvh8wKXYCabmYOa//ko67mT/ANmYns/LoY4U/pd8V4s+r9+zcdIFXmLHO1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.686.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7DUyQ3zZ7qhBDRxWEEgR4lOXQfB7Pp9VDsg3UTY1MEWZUTncSKaWuHIbxJ30wLs/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.137.0/index.min.mjs": "sha384-7DUyQ3zZ7qhBDRxWEEgR4lOXQfB7Pp9VDsg3UTY1MEWZUTncSKaWuHIbxJ30wLs/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.137.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-z39Rw5qtKBY/JbbirFIrb81yEnEttRql7JYmL53PDayza9L0Sy9vFLTb7thedeSu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.503.1/index.min.mjs": "sha384-z39Rw5qtKBY/JbbirFIrb81yEnEttRql7JYmL53PDayza9L0Sy9vFLTb7thedeSu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.503.1/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KgWza5npWritnwBmm1rad2uWB3/fV3c+s38bBy9TcTFimgRp9KOSSlFkdRAWFIE7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.259.0/index.min.mjs": "sha384-KgWza5npWritnwBmm1rad2uWB3/fV3c+s38bBy9TcTFimgRp9KOSSlFkdRAWFIE7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.259.0/LICENSE
```

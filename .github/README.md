...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1t7SeV5sCGmYi3AZkkKwoiLDP5JMWjetS4dAIujjykgox9QdlyAa7TOkU14KnVxk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.855.0/index.min.mjs": "sha384-1t7SeV5sCGmYi3AZkkKwoiLDP5JMWjetS4dAIujjykgox9QdlyAa7TOkU14KnVxk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.855.0/LICENSE
```

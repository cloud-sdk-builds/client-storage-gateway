...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-obys6xvsWRx0CV6Hd9f+6C91FezyFx69WKCytAcvEhlZ8fFXcLqDcflseVu5H5Rk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.650.0/index.min.mjs": "sha384-obys6xvsWRx0CV6Hd9f+6C91FezyFx69WKCytAcvEhlZ8fFXcLqDcflseVu5H5Rk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.650.0/LICENSE
```

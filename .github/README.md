...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-juNZUktUdvmdMEirG2Xci9s7e7+2Te0UX/vb5yD0VOhgekBs5zCW6fwQsf6M/4xY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.699.0/index.min.mjs": "sha384-juNZUktUdvmdMEirG2Xci9s7e7+2Te0UX/vb5yD0VOhgekBs5zCW6fwQsf6M/4xY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.699.0/LICENSE
```

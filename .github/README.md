...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oHyBOBQIWJpDikpFAKT/IjM2C+nM7Sky6C1wKb0fy5QpkmqS6l8LU8fpSPSXmEtK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.616.0/index.min.mjs": "sha384-oHyBOBQIWJpDikpFAKT/IjM2C+nM7Sky6C1wKb0fy5QpkmqS6l8LU8fpSPSXmEtK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.616.0/LICENSE
```

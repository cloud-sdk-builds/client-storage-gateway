...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DWL6Hs71dXB3BKIO9GVF314NDCCQKEbqjgiGXMdtUPnIsJukQmu8n4LsNq6XWXGG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.476.0/index.min.mjs": "sha384-DWL6Hs71dXB3BKIO9GVF314NDCCQKEbqjgiGXMdtUPnIsJukQmu8n4LsNq6XWXGG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.476.0/LICENSE
```

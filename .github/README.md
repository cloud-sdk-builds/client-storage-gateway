...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k2XyiPdOSy5P/3LBQ2wgA8jc1w6WxoTnmGiag1fdX/Jbd6G/+TlYtd3Se3w4T9qp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.16.0/index.min.mjs": "sha384-k2XyiPdOSy5P/3LBQ2wgA8jc1w6WxoTnmGiag1fdX/Jbd6G/+TlYtd3Se3w4T9qp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.16.0/LICENSE
```

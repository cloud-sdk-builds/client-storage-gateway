...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.462.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.462.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IFWsYOHK4a9SVW5mpYCckq82Z7Spgqa9E51F+tvIk1lU98A6vLD8SnpqBYHxfyHO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.462.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.462.0/index.min.mjs": "sha384-IFWsYOHK4a9SVW5mpYCckq82Z7Spgqa9E51F+tvIk1lU98A6vLD8SnpqBYHxfyHO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.462.0/LICENSE
```

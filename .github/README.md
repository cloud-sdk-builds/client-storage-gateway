...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2jk0l4HGBGyKY0uqv1kk0eDveFUSak8DNz5LQLpf3OzAFfC5+hzlZDM8RokjRJjm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.201.0/index.min.mjs": "sha384-2jk0l4HGBGyKY0uqv1kk0eDveFUSak8DNz5LQLpf3OzAFfC5+hzlZDM8RokjRJjm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.201.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4u9Ed/2DZab7us7oJAV0ZJuhRTfzJxsMtPPqRDwbm5RM9pNcvNh9Ku/vLC6DkTTS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.145.0/index.min.mjs": "sha384-4u9Ed/2DZab7us7oJAV0ZJuhRTfzJxsMtPPqRDwbm5RM9pNcvNh9Ku/vLC6DkTTS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.145.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.183.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.183.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1FvcSD6J+FEe9qr5q+udQIrbEAhMOUqZ223cK8HMoPvYL6Iek+HeBr/sVclzjMKN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.183.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.183.0/index.min.mjs": "sha384-1FvcSD6J+FEe9qr5q+udQIrbEAhMOUqZ223cK8HMoPvYL6Iek+HeBr/sVclzjMKN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.183.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M+V6eT6F3VB85Gjl8nrYvLO+UUPmO+jSvJiDQOTZue/t0P/nnnCmSvQclhHjdvak
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.297.0/index.min.mjs": "sha384-M+V6eT6F3VB85Gjl8nrYvLO+UUPmO+jSvJiDQOTZue/t0P/nnnCmSvQclhHjdvak"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.297.0/LICENSE
```

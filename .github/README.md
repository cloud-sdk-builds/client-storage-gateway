...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6+Ja4taPkCncI3Hjz3zGZO621LlIZRJLGlZ+z+JxVJPY15j/9TSKS89WaE9qGFGg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.465.0/index.min.mjs": "sha384-6+Ja4taPkCncI3Hjz3zGZO621LlIZRJLGlZ+z+JxVJPY15j/9TSKS89WaE9qGFGg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.465.0/LICENSE
```

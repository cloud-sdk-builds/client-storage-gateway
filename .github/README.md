...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DfrpRt94YHNx6RGaQxqH+gVs4aad88FqBfZsJOhl3cs7oBNholxa1NghxWaY6WnN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.154.0/index.min.mjs": "sha384-DfrpRt94YHNx6RGaQxqH+gVs4aad88FqBfZsJOhl3cs7oBNholxa1NghxWaY6WnN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.154.0/LICENSE
```

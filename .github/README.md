...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.262.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.262.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WBKOgm0VjmsMRML4Ure+59XAaaI0dKhjqp2nXGdcliQPFT85N0C+UaU2UOm1n0xC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.262.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.262.0/index.min.mjs": "sha384-WBKOgm0VjmsMRML4Ure+59XAaaI0dKhjqp2nXGdcliQPFT85N0C+UaU2UOm1n0xC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.262.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/HdC87BGXEi6r5UVbUVwlnfe7PLLb0m7Q5tmIdQaG4E6XBbpjnvEfnyCwJ53wwd/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.485.0/index.min.mjs": "sha384-/HdC87BGXEi6r5UVbUVwlnfe7PLLb0m7Q5tmIdQaG4E6XBbpjnvEfnyCwJ53wwd/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.485.0/LICENSE
```

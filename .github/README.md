...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-St82w9HBYO0Pl6fWoPCvGQRinbiEoEWlfXkV5GHchVR62C2mcAx3NuzlSC2P0LJN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.587.0/index.min.mjs": "sha384-St82w9HBYO0Pl6fWoPCvGQRinbiEoEWlfXkV5GHchVR62C2mcAx3NuzlSC2P0LJN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.587.0/LICENSE
```

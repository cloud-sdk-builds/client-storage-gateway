...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SyKxhyzUqEqV7N0sFtSfZf3D90W9U6RUJSxnROb+CLlaePjmzKHg7Z+cf/1pXApH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.226.0/index.min.mjs": "sha384-SyKxhyzUqEqV7N0sFtSfZf3D90W9U6RUJSxnROb+CLlaePjmzKHg7Z+cf/1pXApH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.226.0/LICENSE
```

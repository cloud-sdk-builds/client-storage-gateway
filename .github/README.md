...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.231.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.231.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+vkLen3Y/QsCfjsbr+DpkrLw2wAWdHBG00l+VsmDflS6aXhdrlkKSnuLFsDr5Olr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.231.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.231.0/index.min.mjs": "sha384-+vkLen3Y/QsCfjsbr+DpkrLw2wAWdHBG00l+VsmDflS6aXhdrlkKSnuLFsDr5Olr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.231.0/LICENSE
```

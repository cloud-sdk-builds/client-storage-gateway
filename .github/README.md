...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EThFfQp/kkDEodVcqGtkDS7hAhcAJHqEGxZWZoT6LYqSpTNlv0oj8lkHsCjpn+P4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.609.0/index.min.mjs": "sha384-EThFfQp/kkDEodVcqGtkDS7hAhcAJHqEGxZWZoT6LYqSpTNlv0oj8lkHsCjpn+P4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.609.0/LICENSE
```

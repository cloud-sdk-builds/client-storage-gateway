...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ogOxgPA74HYR9h4Npp2kJWzySO+kg11ax5rG5uSqwfbsACicFWGQQWMXTOKxU2sy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.252.0/index.min.mjs": "sha384-ogOxgPA74HYR9h4Npp2kJWzySO+kg11ax5rG5uSqwfbsACicFWGQQWMXTOKxU2sy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.252.0/LICENSE
```

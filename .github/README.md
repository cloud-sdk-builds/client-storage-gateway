...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.109.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2U4MLPlyNIX9DGegX033c5GDNxixoG8Zoec9qUpOIBvwHoOqoAvWVHkaqmYh76TA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.109.0/index.min.mjs": "sha384-2U4MLPlyNIX9DGegX033c5GDNxixoG8Zoec9qUpOIBvwHoOqoAvWVHkaqmYh76TA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.109.0/LICENSE
```

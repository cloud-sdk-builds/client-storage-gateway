...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tTyEX+3r52WTxSIoJ/moMbLsUMUn0QeSbg6nPJsJ2vr3fjO0PEsgQvf8roLNb/YT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.445.0/index.min.mjs": "sha384-tTyEX+3r52WTxSIoJ/moMbLsUMUn0QeSbg6nPJsJ2vr3fjO0PEsgQvf8roLNb/YT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.445.0/LICENSE
```

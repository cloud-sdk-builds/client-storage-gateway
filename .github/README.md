...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QJkYG4ZTxM/t7HQ22NWLQw9idYso8w3kmM9Jbv9+rw+JfqAKcKaaLhL4uhj+YyU9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.750.0/index.min.mjs": "sha384-QJkYG4ZTxM/t7HQ22NWLQw9idYso8w3kmM9Jbv9+rw+JfqAKcKaaLhL4uhj+YyU9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.750.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.474.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.474.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gzlc+hzhsktTQOx6zhOexukUnaMOCyExuZO0pNZvi+TQGcCQA35NiYHM4x+9zzwd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.474.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.474.0/index.min.mjs": "sha384-Gzlc+hzhsktTQOx6zhOexukUnaMOCyExuZO0pNZvi+TQGcCQA35NiYHM4x+9zzwd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.474.0/LICENSE
```

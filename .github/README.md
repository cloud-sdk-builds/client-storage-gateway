...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/k79bu/E9oCmLB8nqIsHrXD0VJk0561wbcHIBCDXYTIfd+JC/lUdM4iiFuXMnSJN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.846.0/index.min.mjs": "sha384-/k79bu/E9oCmLB8nqIsHrXD0VJk0561wbcHIBCDXYTIfd+JC/lUdM4iiFuXMnSJN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.846.0/LICENSE
```

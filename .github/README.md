...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mMIM5ik03yXm+/0gGfQ1H0NKRVFJLqJLOklCOkF+sx7r0I6AYRHBFACDgUQK/zDB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.382.0/index.min.mjs": "sha384-mMIM5ik03yXm+/0gGfQ1H0NKRVFJLqJLOklCOkF+sx7r0I6AYRHBFACDgUQK/zDB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.382.0/LICENSE
```

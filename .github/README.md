...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HWfzUysdQmtv3cR9kubzDMdS/5kODOykngj7SyN3sbsCp8tDcmuYo3FbIHmhmdmD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.721.0/index.min.mjs": "sha384-HWfzUysdQmtv3cR9kubzDMdS/5kODOykngj7SyN3sbsCp8tDcmuYo3FbIHmhmdmD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.721.0/LICENSE
```

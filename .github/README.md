...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-niJcDZ8ft9IvtZrHz7zqIHSadiS9co5mwy61YBM7Uoelx65+Axwoh3vqWBV9AAef
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.714.0/index.min.mjs": "sha384-niJcDZ8ft9IvtZrHz7zqIHSadiS9co5mwy61YBM7Uoelx65+Axwoh3vqWBV9AAef"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.714.0/LICENSE
```

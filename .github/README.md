...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.11.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.11.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZQ7Yb4WlMyeiymP4bCYdJ+NrqhJElzixBqedGBhWMR+6WnMJdd4uOsqoCkxby3P5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.11.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.11.0/index.min.mjs": "sha384-ZQ7Yb4WlMyeiymP4bCYdJ+NrqhJElzixBqedGBhWMR+6WnMJdd4uOsqoCkxby3P5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.11.0/LICENSE
```

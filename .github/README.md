...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MxRVHSz8SM75VwdVPC3jVwaadAwk+YypYblfzWR3O1jWARBipS9HKAA87Ym02zrA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.988.0/index.min.mjs": "sha384-MxRVHSz8SM75VwdVPC3jVwaadAwk+YypYblfzWR3O1jWARBipS9HKAA87Ym02zrA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.988.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C73m2MNFD3yGulgO1Y3Hflpdhyv9a+YQT78llC9HZUW9zUfcDOAnPsMZ0CAw+giZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.658.0/index.min.mjs": "sha384-C73m2MNFD3yGulgO1Y3Hflpdhyv9a+YQT78llC9HZUW9zUfcDOAnPsMZ0CAw+giZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.658.0/LICENSE
```

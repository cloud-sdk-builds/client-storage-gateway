...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rOqre23jhj0LNXWJLK/ZrJwMHdsEEQreyRyZL7WPmz3KqjYZ5T6siHisf2Q46tIN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.387.0/index.min.mjs": "sha384-rOqre23jhj0LNXWJLK/ZrJwMHdsEEQreyRyZL7WPmz3KqjYZ5T6siHisf2Q46tIN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.387.0/LICENSE
```

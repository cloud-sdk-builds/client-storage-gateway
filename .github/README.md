...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fQp+EfPZti0pCwtSuNMmIMGMm7oQqAKHynJKEKBlC79lcS0DFb1OOb2bsDttGgAp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.863.0/index.min.mjs": "sha384-fQp+EfPZti0pCwtSuNMmIMGMm7oQqAKHynJKEKBlC79lcS0DFb1OOb2bsDttGgAp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.863.0/LICENSE
```

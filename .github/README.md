...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bToK9Trmd/Vw+lVZ8Iu0ORrVHe8cq3ZzOD4Ufe78NbY5viOhO33N4X8yrwuxMfOK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.882.0/index.min.mjs": "sha384-bToK9Trmd/Vw+lVZ8Iu0ORrVHe8cq3ZzOD4Ufe78NbY5viOhO33N4X8yrwuxMfOK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.882.0/LICENSE
```

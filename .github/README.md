...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1tgBzDDs/2RdDAUBqrHqRt6nP742BoquULywLdYI/sn+9WxmSTL2gB2gFZ+jm+AU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.799.0/index.min.mjs": "sha384-1tgBzDDs/2RdDAUBqrHqRt6nP742BoquULywLdYI/sn+9WxmSTL2gB2gFZ+jm+AU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.799.0/LICENSE
```

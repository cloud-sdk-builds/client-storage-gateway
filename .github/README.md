...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6IonlxI28HZ2rpVh2bOu3QndPzFtSmtOXmq2J4npaTL7mj52dw4vxTy6O+4lhsvS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.49.0/index.min.mjs": "sha384-6IonlxI28HZ2rpVh2bOu3QndPzFtSmtOXmq2J4npaTL7mj52dw4vxTy6O+4lhsvS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.49.0/LICENSE
```

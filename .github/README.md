...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UWodxm8IIvZvJfAKhTJ99HanDGdJEjQ8zAkj/546FvVazL1IXh98s2TDKKTCTiYS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.23.0/index.min.mjs": "sha384-UWodxm8IIvZvJfAKhTJ99HanDGdJEjQ8zAkj/546FvVazL1IXh98s2TDKKTCTiYS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.23.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-whrp7QqHxbBKBBcxKjp/qr4up+/CcKQDHwIABghq6hVzqX35gt3MLVzii4fltoTB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.946.0/index.min.mjs": "sha384-whrp7QqHxbBKBBcxKjp/qr4up+/CcKQDHwIABghq6hVzqX35gt3MLVzii4fltoTB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.946.0/LICENSE
```

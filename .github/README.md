...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-f8Y6VOV/p2vTmi7frbSvr6gchw17cQnhYnD65FTSQQO0Sv7T7xXVmiKzj4juaPT4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.726.1/index.min.mjs": "sha384-f8Y6VOV/p2vTmi7frbSvr6gchw17cQnhYnD65FTSQQO0Sv7T7xXVmiKzj4juaPT4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.726.1/LICENSE
```

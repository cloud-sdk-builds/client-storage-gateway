...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W4GXY1AgFELUBUdX/aaNOTsAgWqeFXqE7R7vzrmgklkCvH6jo3eYDBX5Gp+Vm9l7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.632.0/index.min.mjs": "sha384-W4GXY1AgFELUBUdX/aaNOTsAgWqeFXqE7R7vzrmgklkCvH6jo3eYDBX5Gp+Vm9l7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.632.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vbCQWwA+rrL7gK9jxxOztPXC44yqusR8SsXHPR52HkY6S+NmUL8Kh6EPBCUJMqlm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.295.0/index.min.mjs": "sha384-vbCQWwA+rrL7gK9jxxOztPXC44yqusR8SsXHPR52HkY6S+NmUL8Kh6EPBCUJMqlm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.295.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JdOxGmg8SKjkGq0pwNRS00qq1fohtcvc0mSZ5v4K64wYr2t8YMGFIpwiThsMJTm0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.901.0/index.min.mjs": "sha384-JdOxGmg8SKjkGq0pwNRS00qq1fohtcvc0mSZ5v4K64wYr2t8YMGFIpwiThsMJTm0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.901.0/LICENSE
```

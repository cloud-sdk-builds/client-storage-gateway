...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.161.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.161.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bUEtTuldBbSef/Tq1w1FjRiNIWC2a+6kEHu2Cpiy9XTfBssfAdi9DMVxeQ77/6mR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.161.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.161.0/index.min.mjs": "sha384-bUEtTuldBbSef/Tq1w1FjRiNIWC2a+6kEHu2Cpiy9XTfBssfAdi9DMVxeQ77/6mR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.161.0/LICENSE
```

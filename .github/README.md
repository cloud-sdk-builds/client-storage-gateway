...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ioDkW7eBP8ed6tokEzm4EzGvRbl2zkRXM3pjev3tTTQd+lZjj3o4xdUg8txTs3PD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.848.0/index.min.mjs": "sha384-ioDkW7eBP8ed6tokEzm4EzGvRbl2zkRXM3pjev3tTTQd+lZjj3o4xdUg8txTs3PD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.848.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.910.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.910.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H1/sHarHIWh+fiNKUi66PU4JNINNNvwznWE5auUG9gOBpfyD2MT/Baf0etpWOb8a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.910.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.910.0/index.min.mjs": "sha384-H1/sHarHIWh+fiNKUi66PU4JNINNNvwznWE5auUG9gOBpfyD2MT/Baf0etpWOb8a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.910.0/LICENSE
```

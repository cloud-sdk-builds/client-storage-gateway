...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.939.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.939.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qdsXz9Xy7gGGTEx2RAsZtGgnqgBtq+ozkA3+dmwJT8rVTI+IrnEu+KCwo2GEFjMG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.939.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.939.0/index.min.mjs": "sha384-qdsXz9Xy7gGGTEx2RAsZtGgnqgBtq+ozkA3+dmwJT8rVTI+IrnEu+KCwo2GEFjMG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.939.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IoTldUftjQ1HGt9N+08dHg9YakK1GrpENxaVEmX2Qorey4hzHphOEuDZANXD5jR1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.470.0/index.min.mjs": "sha384-IoTldUftjQ1HGt9N+08dHg9YakK1GrpENxaVEmX2Qorey4hzHphOEuDZANXD5jR1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.470.0/LICENSE
```

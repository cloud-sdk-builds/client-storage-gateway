...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.513.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.513.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ux/xsBZOY0iWF4B4jLNk83SQO+fhFix8ZyIsE4kAVxLogOp6FKJfkiGLkQf18h3R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.513.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.513.0/index.min.mjs": "sha384-ux/xsBZOY0iWF4B4jLNk83SQO+fhFix8ZyIsE4kAVxLogOp6FKJfkiGLkQf18h3R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.513.0/LICENSE
```

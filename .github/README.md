...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.294.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.294.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/9ASwiwQ0Vr/8eZRtJ78OQDRFLAdAGZ7gjIZVyxiIhqhUMbC3IdD0MNwoUwC5VCg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.294.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.294.0/index.min.mjs": "sha384-/9ASwiwQ0Vr/8eZRtJ78OQDRFLAdAGZ7gjIZVyxiIhqhUMbC3IdD0MNwoUwC5VCg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.294.0/LICENSE
```

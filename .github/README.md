...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JBs2ZVRMMZvw6Ff54SHna32TbE+dk2rVB0sdAdI6ztAsaS6lq76TiRRXhCano0gm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.503.0/index.min.mjs": "sha384-JBs2ZVRMMZvw6Ff54SHna32TbE+dk2rVB0sdAdI6ztAsaS6lq76TiRRXhCano0gm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.503.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.13.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.13.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Vygfi3YImstj2+Da+OFKO8RPiyZ9jiGZpHUGr0yTMpbMYvBAyU82hIobKjvGevRp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.13.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.13.0/index.min.mjs": "sha384-Vygfi3YImstj2+Da+OFKO8RPiyZ9jiGZpHUGr0yTMpbMYvBAyU82hIobKjvGevRp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.13.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BA2vvulKdjloC2TCaMgE3YtG2GjKNJYcGN/GUNA0oaE6lsVVhnDi7vZNyaGAEzNp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.623.0/index.min.mjs": "sha384-BA2vvulKdjloC2TCaMgE3YtG2GjKNJYcGN/GUNA0oaE6lsVVhnDi7vZNyaGAEzNp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.623.0/LICENSE
```

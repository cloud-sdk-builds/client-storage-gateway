...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ke2TzfPY5YyXDkYFkAWgt0to6iNnQySMVaaP84IyMfF1y6u5O5yoiCrIss597Yd3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.256.0/index.min.mjs": "sha384-ke2TzfPY5YyXDkYFkAWgt0to6iNnQySMVaaP84IyMfF1y6u5O5yoiCrIss597Yd3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.256.0/LICENSE
```

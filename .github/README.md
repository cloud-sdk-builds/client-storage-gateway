...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.234.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.234.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G02h8IY7gG1pVkBtAf2ffJCkSARs74ewYXvXNYIJsXHSoaXm0SwVlPBTd/9Gxpn5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.234.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.234.0/index.min.mjs": "sha384-G02h8IY7gG1pVkBtAf2ffJCkSARs74ewYXvXNYIJsXHSoaXm0SwVlPBTd/9Gxpn5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.234.0/LICENSE
```

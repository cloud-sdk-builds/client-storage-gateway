...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aqZXepYjK+pNy93QmskIfDj/R9Q5/abMDnPCS+P/qf2DKQ9Ty6+RdlAZlHVwat0/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.743.0/index.min.mjs": "sha384-aqZXepYjK+pNy93QmskIfDj/R9Q5/abMDnPCS+P/qf2DKQ9Ty6+RdlAZlHVwat0/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.743.0/LICENSE
```

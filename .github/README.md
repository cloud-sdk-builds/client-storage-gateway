...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-nlHA5zYNZAg1tdMZr9R15cAGyUetLSrwS6fUYwwpWggfVFafe7ffcy3dvn2E0CeJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.13.1/index.min.mjs": "sha384-nlHA5zYNZAg1tdMZr9R15cAGyUetLSrwS6fUYwwpWggfVFafe7ffcy3dvn2E0CeJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.13.1/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YeWD2gaS535wPsSAr4TeHmaIhSpPKpDmG7zkN1bJA/GhDT8DmIE1tRlSVkQRLvS6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.858.0/index.min.mjs": "sha384-YeWD2gaS535wPsSAr4TeHmaIhSpPKpDmG7zkN1bJA/GhDT8DmIE1tRlSVkQRLvS6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.858.0/LICENSE
```

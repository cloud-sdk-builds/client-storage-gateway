...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m2NqjpVOToTDNzSWwRE+s+5pqfGyC6lRKNfpHFbGA8ba4vjQgbENVdd87bhiv5dI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.935.0/index.min.mjs": "sha384-m2NqjpVOToTDNzSWwRE+s+5pqfGyC6lRKNfpHFbGA8ba4vjQgbENVdd87bhiv5dI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.935.0/LICENSE
```

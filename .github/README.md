...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q08eurYkyPFpFu3VKk16ok6C8ROnbRs4PF9onSfSlEBLqZgaPR3fYwTb3db0l4hH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.713.0/index.min.mjs": "sha384-q08eurYkyPFpFu3VKk16ok6C8ROnbRs4PF9onSfSlEBLqZgaPR3fYwTb3db0l4hH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.713.0/LICENSE
```

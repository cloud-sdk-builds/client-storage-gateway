...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JWDZ4ONcp7WHPUwkr1DiP16X5/a7hCguJvTymDM3IYPJ24ZnTJnlHrXwtliX43YJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.993.0/index.min.mjs": "sha384-JWDZ4ONcp7WHPUwkr1DiP16X5/a7hCguJvTymDM3IYPJ24ZnTJnlHrXwtliX43YJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.993.0/LICENSE
```

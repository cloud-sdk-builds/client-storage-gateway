...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QE6myWeeuhSEA5PVzQDhyKzMeanHQUWcNxV7621khRitgEdbwJsi/XrzK4AzXpbA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.596.0/index.min.mjs": "sha384-QE6myWeeuhSEA5PVzQDhyKzMeanHQUWcNxV7621khRitgEdbwJsi/XrzK4AzXpbA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.596.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/bVFbfOoXH36Fcu8ZIEx5MvE8uMT18jYbWtDM6HHPz5eBTXs+QiYYMF7AW4w9G8N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.899.0/index.min.mjs": "sha384-/bVFbfOoXH36Fcu8ZIEx5MvE8uMT18jYbWtDM6HHPz5eBTXs+QiYYMF7AW4w9G8N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.899.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Aq3mOyhxwyYNaXvQWtIYh4NhakzGRqwc9muawAmyaIDSJs7n5H2CIYGFK8ctlt+C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.987.0/index.min.mjs": "sha384-Aq3mOyhxwyYNaXvQWtIYh4NhakzGRqwc9muawAmyaIDSJs7n5H2CIYGFK8ctlt+C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.987.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k2lWimyfOCOeRXGn6T9Hz3C8LY8wHKm6M5j1CDJrUrjbks0vzOUwd0ns9OXV5HyA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.978.0/index.min.mjs": "sha384-k2lWimyfOCOeRXGn6T9Hz3C8LY8wHKm6M5j1CDJrUrjbks0vzOUwd0ns9OXV5HyA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.978.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t5q1W2krk0ljg9iWyE4FqiwVK/UcW3UlBIfLViWkOzemL1UBsNsJNMW4xDD3mLwG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.955.0/index.min.mjs": "sha384-t5q1W2krk0ljg9iWyE4FqiwVK/UcW3UlBIfLViWkOzemL1UBsNsJNMW4xDD3mLwG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.955.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.357.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.357.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FdgmYg4dcWfbNMobwNqZkZTBAbHS+azG8gq72PaJadaOjRoJ666vGF2lLPTgN0hb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.357.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.357.0/index.min.mjs": "sha384-FdgmYg4dcWfbNMobwNqZkZTBAbHS+azG8gq72PaJadaOjRoJ666vGF2lLPTgN0hb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.357.0/LICENSE
```

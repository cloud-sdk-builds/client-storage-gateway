...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vfJIIz/9ocOz5PNaSv7nKWdpGmNJ82kO1hNQHhcXWb/8mkM8Zii42ycH1r5QLYQ3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.388.0/index.min.mjs": "sha384-vfJIIz/9ocOz5PNaSv7nKWdpGmNJ82kO1hNQHhcXWb/8mkM8Zii42ycH1r5QLYQ3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.388.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.78.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.78.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BwD0JGOBrBJUVKZVcRrXaQ/s94qYHR/iHNNKMr9h9f/EZta/poSXojmeblQvzr7a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.78.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.78.0/index.min.mjs": "sha384-BwD0JGOBrBJUVKZVcRrXaQ/s94qYHR/iHNNKMr9h9f/EZta/poSXojmeblQvzr7a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.78.0/LICENSE
```

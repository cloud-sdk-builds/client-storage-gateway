...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sxa8BhCA8/GbP0XW0xCjLqxi7DxyG059JWoPxvFvteRiUG162YZDH9iM+ikmleDf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.325.0/index.min.mjs": "sha384-sxa8BhCA8/GbP0XW0xCjLqxi7DxyG059JWoPxvFvteRiUG162YZDH9iM+ikmleDf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.325.0/LICENSE
```

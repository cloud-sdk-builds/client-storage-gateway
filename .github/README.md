...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aXJb+vp+jN0pMGAoDt8OtmMe+A+Rqmp8d3tq6XDQHysS0i6GFx9HHZnTNHdQQWLR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.229.0/index.min.mjs": "sha384-aXJb+vp+jN0pMGAoDt8OtmMe+A+Rqmp8d3tq6XDQHysS0i6GFx9HHZnTNHdQQWLR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.229.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gBmqdP84ntZp4ZdH7hj8m92PPf+NK8mlKIawHlMdDLZNN8z1jrzUg/VNdXAVXIN6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.276.0/index.min.mjs": "sha384-gBmqdP84ntZp4ZdH7hj8m92PPf+NK8mlKIawHlMdDLZNN8z1jrzUg/VNdXAVXIN6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.276.0/LICENSE
```

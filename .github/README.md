...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U0NuiftiEzLDk/345ZdqWM3YdWGczTbf8eIF9CRaRUCcIf3fR5DP18uU/sDHWVmL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.954.0/index.min.mjs": "sha384-U0NuiftiEzLDk/345ZdqWM3YdWGczTbf8eIF9CRaRUCcIf3fR5DP18uU/sDHWVmL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.954.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q7bpYK9YxfLYzMGEwAn9TPczb4QPeQ99qrX47OAnWzt8gyns+OkH6anleK2rcDCB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.300.0/index.min.mjs": "sha384-q7bpYK9YxfLYzMGEwAn9TPczb4QPeQ99qrX47OAnWzt8gyns+OkH6anleK2rcDCB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.300.0/LICENSE
```

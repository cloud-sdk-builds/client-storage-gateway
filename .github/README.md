...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.431.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.431.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4pE0iAD8pAEa6yKLHqJnF1eqMMy2b6v8eb5bWPg+w41K4hRZcc+JxtNwFvQ6aAMY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.431.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.431.0/index.min.mjs": "sha384-4pE0iAD8pAEa6yKLHqJnF1eqMMy2b6v8eb5bWPg+w41K4hRZcc+JxtNwFvQ6aAMY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.431.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gnY5+M1Q2ZGkG4BIWqPUAUHicTMk+Kq7Gb0TW8Vj81Gsov7PWHL3dCduCFv4Cv+X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.170.0/index.min.mjs": "sha384-gnY5+M1Q2ZGkG4BIWqPUAUHicTMk+Kq7Gb0TW8Vj81Gsov7PWHL3dCduCFv4Cv+X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.170.0/LICENSE
```

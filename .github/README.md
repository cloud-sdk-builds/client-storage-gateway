...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.3.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.3.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6QjdoYMVc9oZAh7Rz+Fpg52l5GU1x+IT9+T4G4JalUrAzWbQECbmRJqFGIpcmhCd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.3.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.3.0/index.min.mjs": "sha384-6QjdoYMVc9oZAh7Rz+Fpg52l5GU1x+IT9+T4G4JalUrAzWbQECbmRJqFGIpcmhCd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.3.0/LICENSE
```

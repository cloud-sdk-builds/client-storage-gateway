...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.51.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.51.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b+NrvWwq5t/KIyKok1f3/c2uWgPhF6gWE4Sp9b0EVLsmbrSNh8V9vZfYpv+LT5ZH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.51.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.51.0/index.min.mjs": "sha384-b+NrvWwq5t/KIyKok1f3/c2uWgPhF6gWE4Sp9b0EVLsmbrSNh8V9vZfYpv+LT5ZH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.51.0/LICENSE
```

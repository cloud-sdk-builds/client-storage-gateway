...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.309.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KGo9t8k8kdVIEhgrdAjp15V2icgdtZjZTli7xrrDPq6dr/lS/vOwreHThcr4Oco/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.309.0/index.min.mjs": "sha384-KGo9t8k8kdVIEhgrdAjp15V2icgdtZjZTli7xrrDPq6dr/lS/vOwreHThcr4Oco/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.309.0/LICENSE
```

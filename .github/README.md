...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OePuv6a3VwCWpzx2z8SgKeRjIKZK3GFnyXGSc3Leq27ScRsCmAq5LE/B0vnAIOSO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.682.0/index.min.mjs": "sha384-OePuv6a3VwCWpzx2z8SgKeRjIKZK3GFnyXGSc3Leq27ScRsCmAq5LE/B0vnAIOSO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.682.0/LICENSE
```

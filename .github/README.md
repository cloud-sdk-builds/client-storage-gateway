...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+27M8DEVYswb+CSitBZIOjG3NeB2vmXeKNXRPWS7Bm9N7QW4unuHkxOqlu44gSvv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.914.0/index.min.mjs": "sha384-+27M8DEVYswb+CSitBZIOjG3NeB2vmXeKNXRPWS7Bm9N7QW4unuHkxOqlu44gSvv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.914.0/LICENSE
```

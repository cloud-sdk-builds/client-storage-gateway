...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OR9dhr7OjMWkDWzfrf48fVZVYWwOWqfpEf8yk5YcrB/0qUP0+VrkH7P2x4cqeJHy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.52.0/index.min.mjs": "sha384-OR9dhr7OjMWkDWzfrf48fVZVYWwOWqfpEf8yk5YcrB/0qUP0+VrkH7P2x4cqeJHy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.52.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vm+K2TUYTwC/8Vig1A0xCNvPTY+vh87SVRMxH4H1bGC+AYRc/aQG03M2E5Fcr620
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.48.0/index.min.mjs": "sha384-vm+K2TUYTwC/8Vig1A0xCNvPTY+vh87SVRMxH4H1bGC+AYRc/aQG03M2E5Fcr620"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.48.0/LICENSE
```

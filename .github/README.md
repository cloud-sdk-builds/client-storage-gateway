...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+ykgNicI1WcEjyhi/A9oKJ4oXGK+jlTPhNi+lIrYlp8D+XlM4Farn4kN8G4MIyAD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.907.0/index.min.mjs": "sha384-+ykgNicI1WcEjyhi/A9oKJ4oXGK+jlTPhNi+lIrYlp8D+XlM4Farn4kN8G4MIyAD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.907.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c8vSYCcxwhM+87upuVaDl5nK4q7m6Zb3xteFm0Eo2ygy1OzFwjzAH6kNhlgACiL5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.965.0/index.min.mjs": "sha384-c8vSYCcxwhM+87upuVaDl5nK4q7m6Zb3xteFm0Eo2ygy1OzFwjzAH6kNhlgACiL5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.965.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PdZ/+pKS2fY2+bPHtzZgarx/WMb+cxplEZ8+GW7ptx9m5wtVHrVlAySg1Za1+CqF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.131.0/index.min.mjs": "sha384-PdZ/+pKS2fY2+bPHtzZgarx/WMb+cxplEZ8+GW7ptx9m5wtVHrVlAySg1Za1+CqF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.131.0/LICENSE
```

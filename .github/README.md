...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cnlvsHjLdOQJl4T/w1j3JW7+0TijPQMil3RbqnPR+qL/Ptkhib1iW8uVnYlpnGH+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.267.0/index.min.mjs": "sha384-cnlvsHjLdOQJl4T/w1j3JW7+0TijPQMil3RbqnPR+qL/Ptkhib1iW8uVnYlpnGH+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.267.0/LICENSE
```

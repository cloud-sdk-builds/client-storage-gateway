...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GI+PuUMdA9hhyDF32/sa4UgAn2LonNI2hYatWTldRuBU3Hzz0PfN5j468XbfOM6h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.772.0/index.min.mjs": "sha384-GI+PuUMdA9hhyDF32/sa4UgAn2LonNI2hYatWTldRuBU3Hzz0PfN5j468XbfOM6h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.772.0/LICENSE
```

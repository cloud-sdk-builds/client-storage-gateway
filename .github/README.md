...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.306.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.306.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-byZSviY9qNj7higdLjyWk+YPFiUYS5yuGtjbLESrro2vH2S9zHYJyQAhP+G4gn5o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.306.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.306.0/index.min.mjs": "sha384-byZSviY9qNj7higdLjyWk+YPFiUYS5yuGtjbLESrro2vH2S9zHYJyQAhP+G4gn5o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.306.0/LICENSE
```

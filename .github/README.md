...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/THqm26Vn/8IrnELW8/s0fmHsLjmGmCAb2Hd/mOYWIxXbdtZKZ7ycULr53aeTKov
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.741.0/index.min.mjs": "sha384-/THqm26Vn/8IrnELW8/s0fmHsLjmGmCAb2Hd/mOYWIxXbdtZKZ7ycULr53aeTKov"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.741.0/LICENSE
```

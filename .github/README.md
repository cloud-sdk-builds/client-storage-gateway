...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mz6s6V9KBCqJ6Ou/Hkgf/0o7Zm3d7FjdcBXbLxdwH1KIwPbNC2ti7JdGHH2Xg4tQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.649.0/index.min.mjs": "sha384-mz6s6V9KBCqJ6Ou/Hkgf/0o7Zm3d7FjdcBXbLxdwH1KIwPbNC2ti7JdGHH2Xg4tQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.649.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N4Q46itspM0cmJMUXv5J2+6MxKyKsrBWhq2zaubizyBEiTmShcNTfBAoyV5xmQIB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.918.0/index.min.mjs": "sha384-N4Q46itspM0cmJMUXv5J2+6MxKyKsrBWhq2zaubizyBEiTmShcNTfBAoyV5xmQIB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.918.0/LICENSE
```

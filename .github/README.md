...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D+gZ0BFno1FcXWIQZUMZFaETBRldK6C/PNwcKUBGsb1gwCZ7Z68Q+T0S54dA3MN4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.999.0/index.min.mjs": "sha384-D+gZ0BFno1FcXWIQZUMZFaETBRldK6C/PNwcKUBGsb1gwCZ7Z68Q+T0S54dA3MN4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.999.0/LICENSE
```

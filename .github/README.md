...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B9Dp2L/YTef4ObHvHVg20LNSD9Rwah4i5qn//enNZX0nDWXtifwhF3Dv18o4p/O6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.986.0/index.min.mjs": "sha384-B9Dp2L/YTef4ObHvHVg20LNSD9Rwah4i5qn//enNZX0nDWXtifwhF3Dv18o4p/O6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.986.0/LICENSE
```

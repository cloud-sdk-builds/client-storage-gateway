...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-87Jf0+fmGBttL2RSIgNyLOsleQO3VpDTWPLenBd6/LiZzqJVUoFwaTm6ld5tmbnU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.666.0/index.min.mjs": "sha384-87Jf0+fmGBttL2RSIgNyLOsleQO3VpDTWPLenBd6/LiZzqJVUoFwaTm6ld5tmbnU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.666.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E9oEVVVp/vAEkFxfQUdHkIj3/5KINUiobpx+z6aOaQjBafOdnS5y4/kZcsxl5/Cl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.723.0/index.min.mjs": "sha384-E9oEVVVp/vAEkFxfQUdHkIj3/5KINUiobpx+z6aOaQjBafOdnS5y4/kZcsxl5/Cl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.723.0/LICENSE
```

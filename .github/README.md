...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1055.0).
...
- @aws-sdk/client-storage-gateway - [https://cloud-sdk-builds.github.io/?sdk=client-storage-gateway](https://cloud-sdk-builds.github.io/?sdk=client-storage-gateway)
- @aws-sdk/client-storage-gateway v3.1055.0 - [https://cloud-sdk-builds.github.io/?sdk=client-storage-gateway&version=3.1055.0](https://cloud-sdk-builds.github.io/?sdk=client-storage-gateway&version=3.1055.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1055.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IX560FqH7l2wnRGWtcKrotLCKPdj5xwhVKyklSx3OXUB8dq+udS64p37AkZ09P7c
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1055.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1055.0/index.min.mjs": "sha384-IX560FqH7l2wnRGWtcKrotLCKPdj5xwhVKyklSx3OXUB8dq+udS64p37AkZ09P7c"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-storage-gateway";
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1055.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uYH7xXUoWS4kQrBBBn4IrjgncZAfu+9OqNsoLEXXD19iXzHbtii9ySQgkYJ7sD/7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.890.0/index.min.mjs": "sha384-uYH7xXUoWS4kQrBBBn4IrjgncZAfu+9OqNsoLEXXD19iXzHbtii9ySQgkYJ7sD/7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.890.0/LICENSE
```

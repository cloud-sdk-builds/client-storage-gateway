...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1031.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1031.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OyKo58zSGDFZdAkPojkaHXuEW7G6ixaS3H4uU+ylPSPhJzPjWN3zFTtaTyiP2Ip9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1031.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1031.0/index.min.mjs": "sha384-OyKo58zSGDFZdAkPojkaHXuEW7G6ixaS3H4uU+ylPSPhJzPjWN3zFTtaTyiP2Ip9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1031.0/LICENSE
```

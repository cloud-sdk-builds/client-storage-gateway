...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DSYP6hHx+hwqe0WzSKMl0mc0nUMwOu/pvSs1V+zDaigTy9a31cMQNJWmnpahzCVW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.574.0/index.min.mjs": "sha384-DSYP6hHx+hwqe0WzSKMl0mc0nUMwOu/pvSs1V+zDaigTy9a31cMQNJWmnpahzCVW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.574.0/LICENSE
```

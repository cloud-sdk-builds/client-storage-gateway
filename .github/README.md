...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OOVMVVFnxafyL+CmFeSKiDMzA2GJ+lmKc/QTAw42DBmu9STOchuAH+kvG5JX83dd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.328.0/index.min.mjs": "sha384-OOVMVVFnxafyL+CmFeSKiDMzA2GJ+lmKc/QTAw42DBmu9STOchuAH+kvG5JX83dd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.328.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d4PTu5IDWKzqbu82e5+T79hBvMfzHZUsKtf8H6+5HR/mszXgM0q6kxZZFNH+HwCQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.337.0/index.min.mjs": "sha384-d4PTu5IDWKzqbu82e5+T79hBvMfzHZUsKtf8H6+5HR/mszXgM0q6kxZZFNH+HwCQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.337.0/LICENSE
```

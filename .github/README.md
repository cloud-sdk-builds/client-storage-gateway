...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w2ac4BCW/MRFqaXhsyp+UMuxvGxXTbjKKB+dKlKR83EFmY2f6HUYOhAp9WG4hrax
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.345.0/index.min.mjs": "sha384-w2ac4BCW/MRFqaXhsyp+UMuxvGxXTbjKKB+dKlKR83EFmY2f6HUYOhAp9WG4hrax"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.345.0/LICENSE
```

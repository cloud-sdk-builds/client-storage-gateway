...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.590.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.590.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-06Y9GlSEhDbdJn1fyOuEJlyWdEPdZccldwftBp9CsA88YNi0en4Z7lEl5OLOfPUh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.590.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.590.0/index.min.mjs": "sha384-06Y9GlSEhDbdJn1fyOuEJlyWdEPdZccldwftBp9CsA88YNi0en4Z7lEl5OLOfPUh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.590.0/LICENSE
```

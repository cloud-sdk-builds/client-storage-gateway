...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.14.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.14.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aJOdc+aCCTIxE7xAYvXzdMyrR5iF5czF5yqdTMNbYvEVLV5zdTGo+cia3zJz2jrc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.14.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.14.0/index.min.mjs": "sha384-aJOdc+aCCTIxE7xAYvXzdMyrR5iF5czF5yqdTMNbYvEVLV5zdTGo+cia3zJz2jrc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.14.0/LICENSE
```

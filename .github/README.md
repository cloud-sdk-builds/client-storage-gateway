...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q/tEqt/urk20LVHQXDwoHsPdy66T2jWoXszsWQ/zNi9xZpf6TblvAnnLdDHrwlfK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.4.1/index.min.mjs": "sha384-Q/tEqt/urk20LVHQXDwoHsPdy66T2jWoXszsWQ/zNi9xZpf6TblvAnnLdDHrwlfK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.4.1/LICENSE
```

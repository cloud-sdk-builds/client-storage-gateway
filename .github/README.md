...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.301.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.301.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3HLJ5SQs5E3OnU+EBl4pePwlkouKbxtznI3lcUo4IaFd4x+PeXLSUgx4AILVakuA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.301.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.301.0/index.min.mjs": "sha384-3HLJ5SQs5E3OnU+EBl4pePwlkouKbxtznI3lcUo4IaFd4x+PeXLSUgx4AILVakuA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.301.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.46.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.46.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oHLMZzuybXrvKHhVpN4YRz7n4YDYuQo2QJ36X2hglgU8ICn18HO60zWTNki28dq7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.46.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.46.0/index.min.mjs": "sha384-oHLMZzuybXrvKHhVpN4YRz7n4YDYuQo2QJ36X2hglgU8ICn18HO60zWTNki28dq7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.46.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4sY/cIOLfRgepBzsB2Jq/VpxyDNqS5OO6Gtt1LweSC9BjnGcVTBrVYotaGXDui2k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.19.0/index.min.mjs": "sha384-4sY/cIOLfRgepBzsB2Jq/VpxyDNqS5OO6Gtt1LweSC9BjnGcVTBrVYotaGXDui2k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.19.0/LICENSE
```

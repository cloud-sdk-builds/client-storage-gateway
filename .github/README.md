...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4tCZxQsAezDWu4v+EPYO0ZNKtR3hlggGU4cATrrKJ1vXKI10A7Orii8FU3LsU/ex
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.731.0/index.min.mjs": "sha384-4tCZxQsAezDWu4v+EPYO0ZNKtR3hlggGU4cATrrKJ1vXKI10A7Orii8FU3LsU/ex"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.731.0/LICENSE
```

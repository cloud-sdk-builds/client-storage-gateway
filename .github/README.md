...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iTjNoy7Io0lE5RrT6ar9v3io71r4wH2d2pFYINnpIMcXHRnoQfSjUpfaHaT6/6Kx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.460.0/index.min.mjs": "sha384-iTjNoy7Io0lE5RrT6ar9v3io71r4wH2d2pFYINnpIMcXHRnoQfSjUpfaHaT6/6Kx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.460.0/LICENSE
```

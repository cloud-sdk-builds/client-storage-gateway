...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QAKKrmmPYrao4JcPwIYzNLeroZ2/p9NydgXCBMZc1uhjBw4YnSVTyxDxAO3m8bUz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.56.0/index.min.mjs": "sha384-QAKKrmmPYrao4JcPwIYzNLeroZ2/p9NydgXCBMZc1uhjBw4YnSVTyxDxAO3m8bUz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.56.0/LICENSE
```

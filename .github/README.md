...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qhOAh7dKiI6Lb4C7XKEZOPSBq+X3qn7c3VpEkpQNTFFFXl2/TNmtEEvJ+cutAmua
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.245.0/index.min.mjs": "sha384-qhOAh7dKiI6Lb4C7XKEZOPSBq+X3qn7c3VpEkpQNTFFFXl2/TNmtEEvJ+cutAmua"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.245.0/LICENSE
```

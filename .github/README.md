...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GISnqsHrAz8bPidrPcyobk4VNZ9XtpWbS+By3PtUhlFh0MXkK74DseZ497Baw6VV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.692.0/index.min.mjs": "sha384-GISnqsHrAz8bPidrPcyobk4VNZ9XtpWbS+By3PtUhlFh0MXkK74DseZ497Baw6VV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.692.0/LICENSE
```

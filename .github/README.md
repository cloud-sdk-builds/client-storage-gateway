...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cnV4NHIjUHVSv48yr2tOaQVWvwsv7u7n96rkMuNo3ZHTN/EZC6JOE2SJcgrVo4QT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.962.0/index.min.mjs": "sha384-cnV4NHIjUHVSv48yr2tOaQVWvwsv7u7n96rkMuNo3ZHTN/EZC6JOE2SJcgrVo4QT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.962.0/LICENSE
```

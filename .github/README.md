...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bv2utqdiqcZeCPOsoq7itPUDYEoRm2tU60mfyRNQ7P2caOYQM4guHx6mzgMmlBBu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.25.0/index.min.mjs": "sha384-bv2utqdiqcZeCPOsoq7itPUDYEoRm2tU60mfyRNQ7P2caOYQM4guHx6mzgMmlBBu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.25.0/LICENSE
```

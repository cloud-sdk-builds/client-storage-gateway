...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RtC5qP53+OT8+FoXF+APiGMvtL12LW3qvbZPdU7zMQufHehXW2+maJzm/8cT5hUb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.998.0/index.min.mjs": "sha384-RtC5qP53+OT8+FoXF+APiGMvtL12LW3qvbZPdU7zMQufHehXW2+maJzm/8cT5hUb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.998.0/LICENSE
```

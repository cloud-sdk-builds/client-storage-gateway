...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7E6IsT/1oZkJfWY2/c8XjUC49m5IVbP+grgNX15LpkHzsIiqWchEb1iQ/Z1MU25f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.796.0/index.min.mjs": "sha384-7E6IsT/1oZkJfWY2/c8XjUC49m5IVbP+grgNX15LpkHzsIiqWchEb1iQ/Z1MU25f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.796.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dePnnwF5sl5NOc3AAHDXVtS7kI7KuvislZO3ET9xuNdW6r+HRN71CztNxEFI9JGS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.920.0/index.min.mjs": "sha384-dePnnwF5sl5NOc3AAHDXVtS7kI7KuvislZO3ET9xuNdW6r+HRN71CztNxEFI9JGS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.920.0/LICENSE
```

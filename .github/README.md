...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IjzJfJtW67oqHK71QyCupHyaUH9H8vfqlQHUMzc4/0GFIB8r5fcSyEZ9OqywvKDq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.675.0/index.min.mjs": "sha384-IjzJfJtW67oqHK71QyCupHyaUH9H8vfqlQHUMzc4/0GFIB8r5fcSyEZ9OqywvKDq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.675.0/LICENSE
```

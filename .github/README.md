...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q9tMQVuVKlyfflGiG6hp1U7KPkfPMDjxU7Ygt5rgvKL8+mVv/oSGdfDcZSQWPMhb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.185.0/index.min.mjs": "sha384-q9tMQVuVKlyfflGiG6hp1U7KPkfPMDjxU7Ygt5rgvKL8+mVv/oSGdfDcZSQWPMhb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.185.0/LICENSE
```

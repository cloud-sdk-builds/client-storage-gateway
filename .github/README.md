...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YRxBHSoYM8RQ/qNRHk7JbVaSVOGMzghP6KC/1DJeTKf3bK92rTgc1QKUH+x7tP4R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.353.0/index.min.mjs": "sha384-YRxBHSoYM8RQ/qNRHk7JbVaSVOGMzghP6KC/1DJeTKf3bK92rTgc1QKUH+x7tP4R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.353.0/LICENSE
```

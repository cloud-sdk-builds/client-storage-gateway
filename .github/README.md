...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x/BNPp6gScbtkwZKrfejPGL6tVhPZF4cZDkw1XMTFzfKt54BnHlaiHv9DH8S1rCN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.468.0/index.min.mjs": "sha384-x/BNPp6gScbtkwZKrfejPGL6tVhPZF4cZDkw1XMTFzfKt54BnHlaiHv9DH8S1rCN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.468.0/LICENSE
```

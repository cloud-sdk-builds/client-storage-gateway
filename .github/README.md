...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-05GdN9xANPtNsG9wOvlAkaAY65a81jZSmkl1aIEWNCjDL80TgbRzQ8PvJsRVSXZV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.872.0/index.min.mjs": "sha384-05GdN9xANPtNsG9wOvlAkaAY65a81jZSmkl1aIEWNCjDL80TgbRzQ8PvJsRVSXZV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.872.0/LICENSE
```

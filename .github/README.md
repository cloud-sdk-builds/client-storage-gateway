...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1007.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1007.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a3hw68y8wUeUw8mQUF42mZqSt5D63w3QrwKgSCtgXzUntKbUIA/AadCKh+EvXWzn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1007.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1007.0/index.min.mjs": "sha384-a3hw68y8wUeUw8mQUF42mZqSt5D63w3QrwKgSCtgXzUntKbUIA/AadCKh+EvXWzn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1007.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pHQ57kL54Qj3v6USW8G9Hd/9FzkQQQQ97Z3GHcrFcFb+ERgYWO8kywPIwwuMCYXY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.54.0/index.min.mjs": "sha384-pHQ57kL54Qj3v6USW8G9Hd/9FzkQQQQ97Z3GHcrFcFb+ERgYWO8kywPIwwuMCYXY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.54.0/LICENSE
```

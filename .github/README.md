...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q3pg2p044Y0LPOoeq3Gswdc7Ja/ugsPxSDndVM1vC4hHLUXuqw47eajDuag4lw6G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.567.0/index.min.mjs": "sha384-q3pg2p044Y0LPOoeq3Gswdc7Ja/ugsPxSDndVM1vC4hHLUXuqw47eajDuag4lw6G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.567.0/LICENSE
```

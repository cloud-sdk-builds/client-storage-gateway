...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p7hBBtPuD7YYciZMECVmyJb1RGJqlXcr3nE6Jz8F691O5ZRSQuDaNtlym6t7NsZf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.290.0/index.min.mjs": "sha384-p7hBBtPuD7YYciZMECVmyJb1RGJqlXcr3nE6Jz8F691O5ZRSQuDaNtlym6t7NsZf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.290.0/LICENSE
```

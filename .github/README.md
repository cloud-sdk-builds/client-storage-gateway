...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LfMrr/kWIjC5bw/0DKoHKtZZTdTPJDTuSxgzSX9l7SRzIvZjqYbs2smQPfVBKCDH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.254.0/index.min.mjs": "sha384-LfMrr/kWIjC5bw/0DKoHKtZZTdTPJDTuSxgzSX9l7SRzIvZjqYbs2smQPfVBKCDH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.254.0/LICENSE
```

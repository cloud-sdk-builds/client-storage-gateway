...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H1FHzPKc94vmw47ed7eoYV+lxzLvOeSwWl0s2xDL5VPPFTV8ww8/SyPH1VrKrGS7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.803.0/index.min.mjs": "sha384-H1FHzPKc94vmw47ed7eoYV+lxzLvOeSwWl0s2xDL5VPPFTV8ww8/SyPH1VrKrGS7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.803.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eSeRXRAPoMEnPWq/dMeT0eMvGgxHH9A5U479mFLzhXnOIYEmD5irN9IhAkJPFgcf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.665.0/index.min.mjs": "sha384-eSeRXRAPoMEnPWq/dMeT0eMvGgxHH9A5U479mFLzhXnOIYEmD5irN9IhAkJPFgcf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.665.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1020.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1020.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aMORXeyEBvl64CGOs8IW+6jivToVxACr+WYKXty35YZeyohW+EjShgWooM7FdhpP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1020.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1020.0/index.min.mjs": "sha384-aMORXeyEBvl64CGOs8IW+6jivToVxACr+WYKXty35YZeyohW+EjShgWooM7FdhpP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1020.0/LICENSE
```

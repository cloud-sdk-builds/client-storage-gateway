...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LV1zg7MF4Zx5V2lKPyYB0/uh9UdSGS97uQL67wUwuBTG3gXY+fTupKJhobjMCFMj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.15.0/index.min.mjs": "sha384-LV1zg7MF4Zx5V2lKPyYB0/uh9UdSGS97uQL67wUwuBTG3gXY+fTupKJhobjMCFMj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.15.0/LICENSE
```

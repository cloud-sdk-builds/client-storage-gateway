...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-582oKsZxPSLmX7NaOZssukL6Ttqt8+TK0uexIy+hy4EHTY65mPJy6/QI+cW7njZt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.933.0/index.min.mjs": "sha384-582oKsZxPSLmX7NaOZssukL6Ttqt8+TK0uexIy+hy4EHTY65mPJy6/QI+cW7njZt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.933.0/LICENSE
```

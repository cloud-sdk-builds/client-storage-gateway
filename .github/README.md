...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.279.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.279.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K4eQv8gWSGKBuXfE9YpAZIe9eHwgrFRYyXinYVpXKI/K6yam6l3OKIEcpBv3Ipff
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.279.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.279.0/index.min.mjs": "sha384-K4eQv8gWSGKBuXfE9YpAZIe9eHwgrFRYyXinYVpXKI/K6yam6l3OKIEcpBv3Ipff"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.279.0/LICENSE
```

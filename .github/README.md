...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+TpOK2x5yUyCO/0GW/WAvaqLV0FUUBuh/3qb+dw/t2mzuhP2TDkuR80uF1lnmvCU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.687.0/index.min.mjs": "sha384-+TpOK2x5yUyCO/0GW/WAvaqLV0FUUBuh/3qb+dw/t2mzuhP2TDkuR80uF1lnmvCU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.687.0/LICENSE
```

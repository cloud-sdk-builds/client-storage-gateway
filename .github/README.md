...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JXU/qfLEni5B++l/tFd4l2MQ0iA2+8hqan2tP8jyLy+PFLp5vT1RwDTO+iiGW8iM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.37.0/index.min.mjs": "sha384-JXU/qfLEni5B++l/tFd4l2MQ0iA2+8hqan2tP8jyLy+PFLp5vT1RwDTO+iiGW8iM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.37.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.837.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.837.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rkXnsDtcySPGWQZojq3zyjW2WjKc0crwCsROVLV1ibgziVeH8syyzqKpW4McY4N3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.837.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.837.0/index.min.mjs": "sha384-rkXnsDtcySPGWQZojq3zyjW2WjKc0crwCsROVLV1ibgziVeH8syyzqKpW4McY4N3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.837.0/LICENSE
```

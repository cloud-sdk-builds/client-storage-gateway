...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-HoRqU8n/ge8HaVYoiB9Ty7IWlc3jHMl8+AarwBHNYxz8bOs7spvkoZ7usKmceBAX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.379.1/index.min.mjs": "sha384-HoRqU8n/ge8HaVYoiB9Ty7IWlc3jHMl8+AarwBHNYxz8bOs7spvkoZ7usKmceBAX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.379.1/LICENSE
```

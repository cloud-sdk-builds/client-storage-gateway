...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1041.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1041.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3StDrvNq0MIHicjaIenWX1lSOmIA0MS3SSCDuv0MCPGQR3M+gNC1sjkaBnQ5Vdqd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1041.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1041.0/index.min.mjs": "sha384-3StDrvNq0MIHicjaIenWX1lSOmIA0MS3SSCDuv0MCPGQR3M+gNC1sjkaBnQ5Vdqd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1041.0/LICENSE
```

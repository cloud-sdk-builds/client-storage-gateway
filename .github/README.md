...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oUvDXv5nYaoeVc9hpIHhoOu2zmGceE8sBwrSFEaiHI9BjtDpmpizhoSD4yHTycqs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.398.0/index.min.mjs": "sha384-oUvDXv5nYaoeVc9hpIHhoOu2zmGceE8sBwrSFEaiHI9BjtDpmpizhoSD4yHTycqs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.398.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.216.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.216.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dMyW+pCHbhAUT1bZ8/f3gEuk1IrGQviddz4IenEH4AVfbGsnMStkq/Tt9dp2ppyh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.216.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.216.0/index.min.mjs": "sha384-dMyW+pCHbhAUT1bZ8/f3gEuk1IrGQviddz4IenEH4AVfbGsnMStkq/Tt9dp2ppyh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.216.0/LICENSE
```

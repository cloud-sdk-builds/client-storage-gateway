...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-puw5nE7lVYGoPSwT8xT6Xo6IRGB7piSNLZWWT2B1+GDPg2yHs06LJbnY/nfSJQLa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.859.0/index.min.mjs": "sha384-puw5nE7lVYGoPSwT8xT6Xo6IRGB7piSNLZWWT2B1+GDPg2yHs06LJbnY/nfSJQLa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.859.0/LICENSE
```

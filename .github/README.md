...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1ln0eZbeqARhjUnwAzvN2wUPEqg7h9Suo3SZmmZ4YL4Tbza7ryiQwq3DlgbrGDym
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.533.0/index.min.mjs": "sha384-1ln0eZbeqARhjUnwAzvN2wUPEqg7h9Suo3SZmmZ4YL4Tbza7ryiQwq3DlgbrGDym"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.533.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d4iECDteuoV1vMyYDS9BnhTDZU24hILtMih25ibytDcEOaYERr408P6bOUJ1JJmD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.81.0/index.min.mjs": "sha384-d4iECDteuoV1vMyYDS9BnhTDZU24hILtMih25ibytDcEOaYERr408P6bOUJ1JJmD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.81.0/LICENSE
```

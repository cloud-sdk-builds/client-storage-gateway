...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.44.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.44.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zdi5w3T566A5lM/lf+yLbJ1BARppNJWUqFvUl1aNkyO+3iQk9lHL8yxgwb5vVTuQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.44.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.44.0/index.min.mjs": "sha384-zdi5w3T566A5lM/lf+yLbJ1BARppNJWUqFvUl1aNkyO+3iQk9lHL8yxgwb5vVTuQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.44.0/LICENSE
```

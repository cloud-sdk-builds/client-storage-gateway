...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KI8452wR5DpkCS/+g3BbSnKaSGiwUySaYJ4iQbu9lmWrzzNTadVUeLVK3UyHGZaF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.947.0/index.min.mjs": "sha384-KI8452wR5DpkCS/+g3BbSnKaSGiwUySaYJ4iQbu9lmWrzzNTadVUeLVK3UyHGZaF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.947.0/LICENSE
```

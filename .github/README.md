...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-umpl7XHRur1FCyb/fqVPG6a57nRn4zRvRQmrTvygqc28jxVeoSt/q9cp31ImorFz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.895.0/index.min.mjs": "sha384-umpl7XHRur1FCyb/fqVPG6a57nRn4zRvRQmrTvygqc28jxVeoSt/q9cp31ImorFz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.895.0/LICENSE
```

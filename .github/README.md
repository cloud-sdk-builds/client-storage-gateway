...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8la/6tQ/MTyk5OUNTmKJHOp4ok68q+PH0fmc9C7K2wm9UMViNi0HKXJYGRTBX2T3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.926.0/index.min.mjs": "sha384-8la/6tQ/MTyk5OUNTmKJHOp4ok68q+PH0fmc9C7K2wm9UMViNi0HKXJYGRTBX2T3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.926.0/LICENSE
```

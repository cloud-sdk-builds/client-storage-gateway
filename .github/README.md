...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O7WY+1rt8I9KI6u0IFY05Yi8faNW3ifg+BBb3WUXloblA81ULLpM4zb/vXyy1rjx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.693.0/index.min.mjs": "sha384-O7WY+1rt8I9KI6u0IFY05Yi8faNW3ifg+BBb3WUXloblA81ULLpM4zb/vXyy1rjx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.693.0/LICENSE
```

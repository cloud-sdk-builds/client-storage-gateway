...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j03VNn4dlkCI0pEMzKRZrhEkQSz8+zxzS0LV3w/pHbwU4yFNhAJd5fcYRHvNhCjd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.335.0/index.min.mjs": "sha384-j03VNn4dlkCI0pEMzKRZrhEkQSz8+zxzS0LV3w/pHbwU4yFNhAJd5fcYRHvNhCjd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.335.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZZGTmRfGIaFR1hnmk5dIgSY9KgHf68Fw4ey/QzGmRryWNgCl/srHPQZ+qv518Vob
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.278.0/index.min.mjs": "sha384-ZZGTmRfGIaFR1hnmk5dIgSY9KgHf68Fw4ey/QzGmRryWNgCl/srHPQZ+qv518Vob"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.278.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-BpIKfjmMnd6vupCu7xMkBUzkEuXZzjXp1qjop47zkvsmV4Vcwy/ImL/tHDZAMH0e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.47.1/index.min.mjs": "sha384-BpIKfjmMnd6vupCu7xMkBUzkEuXZzjXp1qjop47zkvsmV4Vcwy/ImL/tHDZAMH0e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.47.1/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kMKFjBoMMC1GI9SeJTf2Xjfvv9beCTR8Oc7985B/8+t19jV3pBf8z2e+zc4TChXS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.241.0/index.min.mjs": "sha384-kMKFjBoMMC1GI9SeJTf2Xjfvv9beCTR8Oc7985B/8+t19jV3pBf8z2e+zc4TChXS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.241.0/LICENSE
```

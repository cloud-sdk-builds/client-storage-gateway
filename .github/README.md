...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LsY7DDW1vG15LweqQB3UyREfKeEXWaRV71ETkKwbB72qdx2ZrXbIYUL6Kagx5JTH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.952.0/index.min.mjs": "sha384-LsY7DDW1vG15LweqQB3UyREfKeEXWaRV71ETkKwbB72qdx2ZrXbIYUL6Kagx5JTH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.952.0/LICENSE
```

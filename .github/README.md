...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2NWgXa9aDNF0CCjSemJSSzyakp0vYvEtEF+rsiyYAYjwFTRlDcpe0d4x4sr6u7XW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.989.0/index.min.mjs": "sha384-2NWgXa9aDNF0CCjSemJSSzyakp0vYvEtEF+rsiyYAYjwFTRlDcpe0d4x4sr6u7XW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.989.0/LICENSE
```

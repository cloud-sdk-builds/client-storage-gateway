...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Yh0DnDn6d42KQAB0xGC/SE8m8gN1kYUdiV61BFWNSJMWc2kDAMdSHYyqYPP9fwSO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.26.0/index.min.mjs": "sha384-Yh0DnDn6d42KQAB0xGC/SE8m8gN1kYUdiV61BFWNSJMWc2kDAMdSHYyqYPP9fwSO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.26.0/LICENSE
```

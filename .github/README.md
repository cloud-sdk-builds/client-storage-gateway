...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZuZ6f2TSq3vz75TXUuLlXLKuBG1+fnzPd9Y9+nweSnCP5kpa30k9alBj8zFPFmB3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.441.0/index.min.mjs": "sha384-ZuZ6f2TSq3vz75TXUuLlXLKuBG1+fnzPd9Y9+nweSnCP5kpa30k9alBj8zFPFmB3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.441.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4uyOAQ1Ij30BQLowGiRROYVUMM2d+3yWxHeE/nhGU3VFY0z5lSfyB1pgQCnjmzuT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.94.0/index.min.mjs": "sha384-4uyOAQ1Ij30BQLowGiRROYVUMM2d+3yWxHeE/nhGU3VFY0z5lSfyB1pgQCnjmzuT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.94.0/LICENSE
```

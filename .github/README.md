...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.879.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.879.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZDe9Wg4Kv9p2xxxFvQ9uN75cbahGbJfQ6TfUkjM3Pp1sx+NTbcK8pce8d5lrp9qL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.879.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.879.0/index.min.mjs": "sha384-ZDe9Wg4Kv9p2xxxFvQ9uN75cbahGbJfQ6TfUkjM3Pp1sx+NTbcK8pce8d5lrp9qL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.879.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-khFH8qp0jLd02CL0Ra5elxa91yTUiJLTNtHbcbd7P2BPtC1de5Mazq1NbQ7LBO5y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.738.0/index.min.mjs": "sha384-khFH8qp0jLd02CL0Ra5elxa91yTUiJLTNtHbcbd7P2BPtC1de5Mazq1NbQ7LBO5y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.738.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O/16DmEqZKF8Eps9Y/Fg5RpIgMHFaNByAlRoU+yZRp7xaJBfdOZ8JG/SsSlcCCwc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.2.0/index.min.mjs": "sha384-O/16DmEqZKF8Eps9Y/Fg5RpIgMHFaNByAlRoU+yZRp7xaJBfdOZ8JG/SsSlcCCwc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.2.0/LICENSE
```

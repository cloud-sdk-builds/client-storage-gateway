...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MYUbye5xC1LgsTJXXmo8WVhSg7VwSktDk8Mxnt0gRH6HKoZLHZCMKnCQnMxSjmKT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.730.0/index.min.mjs": "sha384-MYUbye5xC1LgsTJXXmo8WVhSg7VwSktDk8Mxnt0gRH6HKoZLHZCMKnCQnMxSjmKT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.730.0/LICENSE
```

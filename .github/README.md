...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NO5tBBJz+rZ03qL2RaKKRDqzGV2t8Cytc7fdKcpZ83BkKu6F8YcuWwBdRCAeNQTQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.906.0/index.min.mjs": "sha384-NO5tBBJz+rZ03qL2RaKKRDqzGV2t8Cytc7fdKcpZ83BkKu6F8YcuWwBdRCAeNQTQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.906.0/LICENSE
```

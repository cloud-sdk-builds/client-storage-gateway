...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-cIVG8xCnnWKmCaCxrIv/K0JHyN/pEDnpFJWEFR+XrZG+EpRKFn2Cczr8ZuJeuadn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.36.1/index.min.mjs": "sha384-cIVG8xCnnWKmCaCxrIv/K0JHyN/pEDnpFJWEFR+XrZG+EpRKFn2Cczr8ZuJeuadn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.36.1/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vLm9w+3zr8wy5lVjTLT7+jLRUabdNqCCYuMb6MzXxiK/M/ys2+tpa1dWyn/tFo7t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.758.0/index.min.mjs": "sha384-vLm9w+3zr8wy5lVjTLT7+jLRUabdNqCCYuMb6MzXxiK/M/ys2+tpa1dWyn/tFo7t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.758.0/LICENSE
```

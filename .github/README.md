...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+ljWDjmLyE69lscrlTvWxBgPnmGQ4rITpO3zYKerkJZ7Jx3paTrPFXZVfBZA3L2y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.600.0/index.min.mjs": "sha384-+ljWDjmLyE69lscrlTvWxBgPnmGQ4rITpO3zYKerkJZ7Jx3paTrPFXZVfBZA3L2y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.600.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BeFFzhuMXIPe26B1aKHarvQpUNSev6725TO7nmeMUuNdKUt2Ge01rnYEa+N0+cNN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.613.0/index.min.mjs": "sha384-BeFFzhuMXIPe26B1aKHarvQpUNSev6725TO7nmeMUuNdKUt2Ge01rnYEa+N0+cNN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.613.0/LICENSE
```

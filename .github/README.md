...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-12hSFTN965xxTy1lSz5PcbfFSHNgu3tSJLWbpRpdMopFb0nr1vkeMoZOLUCOllOt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.716.0/index.min.mjs": "sha384-12hSFTN965xxTy1lSz5PcbfFSHNgu3tSJLWbpRpdMopFb0nr1vkeMoZOLUCOllOt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.716.0/LICENSE
```

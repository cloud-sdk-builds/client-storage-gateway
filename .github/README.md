...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JTWV/XqCkOj1VNz2qb/xLolQ4WwwkcApASw1Ibjmau3GAAr/DmGDQxNd6O760v7f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.423.0/index.min.mjs": "sha384-JTWV/XqCkOj1VNz2qb/xLolQ4WwwkcApASw1Ibjmau3GAAr/DmGDQxNd6O760v7f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.423.0/LICENSE
```

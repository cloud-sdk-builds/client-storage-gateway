...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3BLJpMlyuscN/X2ZxzS+HKl3U+BQbhQtvTCgldD28jnk9DwQ5Nl7zk+tWXCeM4kh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.53.0/index.min.mjs": "sha384-3BLJpMlyuscN/X2ZxzS+HKl3U+BQbhQtvTCgldD28jnk9DwQ5Nl7zk+tWXCeM4kh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.53.0/LICENSE
```

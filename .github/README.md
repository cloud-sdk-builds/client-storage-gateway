...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vAulny0Qd4FwwZqXTK9U5DXQ9ZoNI51F0SOldLrA6i7XdcJkHrKTcZwLyZe+QsTQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.414.0/index.min.mjs": "sha384-vAulny0Qd4FwwZqXTK9U5DXQ9ZoNI51F0SOldLrA6i7XdcJkHrKTcZwLyZe+QsTQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.414.0/LICENSE
```

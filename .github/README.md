...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yC5MXtEfYsgJsgwNxqA2EvhDbZczHsm0DxX0WISok1uH8l2Rpfv0OyiQF77eJPCI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.159.0/index.min.mjs": "sha384-yC5MXtEfYsgJsgwNxqA2EvhDbZczHsm0DxX0WISok1uH8l2Rpfv0OyiQF77eJPCI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.159.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-umE2l4lPhbElbCk62WAAMDLK8aeXMgdOuA08A8NU3J+TJP0+gxmoOyL3SV9AgFEa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.990.0/index.min.mjs": "sha384-umE2l4lPhbElbCk62WAAMDLK8aeXMgdOuA08A8NU3J+TJP0+gxmoOyL3SV9AgFEa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.990.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-FSg9aJ5HPtV57Uke7VgYBoKq8/KR9l24ceUmvR/PlsaRuavXcgzC/Zw5hSpfHDcM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.321.1/index.min.mjs": "sha384-FSg9aJ5HPtV57Uke7VgYBoKq8/KR9l24ceUmvR/PlsaRuavXcgzC/Zw5hSpfHDcM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.321.1/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.188.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.188.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GRROF4+x8xv4wcdkMpRTk57nIyiPlO8y3zL/c4PZRpqXb/v7Z0WlzBSc4PNI/ND0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.188.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.188.0/index.min.mjs": "sha384-GRROF4+x8xv4wcdkMpRTk57nIyiPlO8y3zL/c4PZRpqXb/v7Z0WlzBSc4PNI/ND0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.188.0/LICENSE
```

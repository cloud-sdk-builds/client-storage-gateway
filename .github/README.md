...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.332.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.332.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KyRyhZ3EdLm1YFza7ezpzRXiRfJ4El1+FL8amzCGNdmNFb7oQ4L+DPoF8eYWMoWf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.332.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.332.0/index.min.mjs": "sha384-KyRyhZ3EdLm1YFza7ezpzRXiRfJ4El1+FL8amzCGNdmNFb7oQ4L+DPoF8eYWMoWf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.332.0/LICENSE
```

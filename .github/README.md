...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wEP4IloYdNKvjIqnbahjXAjeBuL3zI3P0VYbz6wwIRh5BusgIUUgQ8OM50CIAxoL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.995.0/index.min.mjs": "sha384-wEP4IloYdNKvjIqnbahjXAjeBuL3zI3P0VYbz6wwIRh5BusgIUUgQ8OM50CIAxoL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.995.0/LICENSE
```

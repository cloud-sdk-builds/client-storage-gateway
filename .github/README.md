...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yQtE1qgzpc8KCKTg/xAb5dEcnKXJF36lDyNVEcPblhiblp4NEH2PDff0iy0pCFGP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.929.0/index.min.mjs": "sha384-yQtE1qgzpc8KCKTg/xAb5dEcnKXJF36lDyNVEcPblhiblp4NEH2PDff0iy0pCFGP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.929.0/LICENSE
```

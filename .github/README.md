...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xUqaIOI0IwDrTNoqTT8vXEtMTTjc3aN6im86Z7wQzXYFmXK9tPdvrBOYxfAdugIh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.775.0/index.min.mjs": "sha384-xUqaIOI0IwDrTNoqTT8vXEtMTTjc3aN6im86Z7wQzXYFmXK9tPdvrBOYxfAdugIh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.775.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1001.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1001.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DKA0zefhE3jbrM3PXKVtYsax1kLBW0+BalVUtfk9j7Xt2r9ENZQgsrHOmvHdZWO+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1001.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1001.0/index.min.mjs": "sha384-DKA0zefhE3jbrM3PXKVtYsax1kLBW0+BalVUtfk9j7Xt2r9ENZQgsrHOmvHdZWO+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1001.0/LICENSE
```

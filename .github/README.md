...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x9JUFWAIF9pg6U412K1GWp/70Yapz4T/fVHvHnXvUzvyvUau5Tjz4h1UcAgZkezT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.985.0/index.min.mjs": "sha384-x9JUFWAIF9pg6U412K1GWp/70Yapz4T/fVHvHnXvUzvyvUau5Tjz4h1UcAgZkezT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.985.0/LICENSE
```

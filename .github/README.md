...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r3fWVWxevfvKyU4VxXfc/w7iEBEDm5YyDnmWsj9xB7de3n+YmG7+zOsT+Un90sTz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.936.0/index.min.mjs": "sha384-r3fWVWxevfvKyU4VxXfc/w7iEBEDm5YyDnmWsj9xB7de3n+YmG7+zOsT+Un90sTz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.936.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/Upi5f5WELADn65sMSDzhdhxbm6v+jWa1BHOfu5UsTGCIsopX+Q4x6UFFBhTkoGz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.35.0/index.min.mjs": "sha384-/Upi5f5WELADn65sMSDzhdhxbm6v+jWa1BHOfu5UsTGCIsopX+Q4x6UFFBhTkoGz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.35.0/LICENSE
```

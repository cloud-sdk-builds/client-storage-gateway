...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h1MuPb7Wus828APFsjl2getoZZ/kdccu3a4RlAFjZBi8/qAhr5utq7jVnbzZyncH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.85.0/index.min.mjs": "sha384-h1MuPb7Wus828APFsjl2getoZZ/kdccu3a4RlAFjZBi8/qAhr5utq7jVnbzZyncH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.85.0/LICENSE
```

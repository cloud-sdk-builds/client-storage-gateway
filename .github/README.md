...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-txEDsrKE836z7iVUvLCBuw4VsjbQ0G+NjNa1wDQstdReAYr88zbyQ0c1IeCj+A6K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.281.0/index.min.mjs": "sha384-txEDsrKE836z7iVUvLCBuw4VsjbQ0G+NjNa1wDQstdReAYr88zbyQ0c1IeCj+A6K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.281.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-VEijYgGBsx7foKvwWP7Z5CpOR1SiS4vnn+dyUG+7GTrab1LNV9ttKGpafmKd/iUe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.6.1/index.min.mjs": "sha384-VEijYgGBsx7foKvwWP7Z5CpOR1SiS4vnn+dyUG+7GTrab1LNV9ttKGpafmKd/iUe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.6.1/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9lDRnmDwzLMzNz01pvT+3F8Cuou/8gm1vFSBO6y7CqAm1mrPqBNvm3r29HTLSsxm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.919.0/index.min.mjs": "sha384-9lDRnmDwzLMzNz01pvT+3F8Cuou/8gm1vFSBO6y7CqAm1mrPqBNvm3r29HTLSsxm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.919.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.734.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.734.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BpiVGWgeDHU5qLw7gLh7f2FkcIzFIiAsZHE6TvkgIiJCfEWTIDWxjCQmsuca4egM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.734.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.734.0/index.min.mjs": "sha384-BpiVGWgeDHU5qLw7gLh7f2FkcIzFIiAsZHE6TvkgIiJCfEWTIDWxjCQmsuca4egM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.734.0/LICENSE
```

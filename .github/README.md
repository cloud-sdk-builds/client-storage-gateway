...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D8esHFZQxhMX2UNCQTnAUQb4lXSbKWOst1r2tI8JxzbwNs1ZVFowqbKqM51HnzCu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.556.0/index.min.mjs": "sha384-D8esHFZQxhMX2UNCQTnAUQb4lXSbKWOst1r2tI8JxzbwNs1ZVFowqbKqM51HnzCu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.556.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YniiByS2k5BgoRJvuW7xhspjuIguDBsITgc8q4ARDJe603ykoxtsjmlUlY4Odch0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.622.0/index.min.mjs": "sha384-YniiByS2k5BgoRJvuW7xhspjuIguDBsITgc8q4ARDJe603ykoxtsjmlUlY4Odch0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.622.0/LICENSE
```

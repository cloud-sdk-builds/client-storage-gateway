...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.481.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.481.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Uz6aLaom8N2D8NS4ytWWOdipWxb9oJRzM5j+S3Vk+RuJ37vZudMDa9a5lJyuqAz0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.481.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.481.0/index.min.mjs": "sha384-Uz6aLaom8N2D8NS4ytWWOdipWxb9oJRzM5j+S3Vk+RuJ37vZudMDa9a5lJyuqAz0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.481.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mm+OZfni+/w6X8LZ9ZcSgm4MSmKiNvQAUDnW+K//W5BLky6DJLcpAvoAC1+Lf5yU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.377.0/index.min.mjs": "sha384-mm+OZfni+/w6X8LZ9ZcSgm4MSmKiNvQAUDnW+K//W5BLky6DJLcpAvoAC1+Lf5yU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.377.0/LICENSE
```

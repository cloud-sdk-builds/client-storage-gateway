...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.352.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.352.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XPVSa2MViLMWVKlCiQjiIxVbONKyO4EU/1ZWwTnvJfmB4mtqgFjqU05waFNOzMUi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.352.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.352.0/index.min.mjs": "sha384-XPVSa2MViLMWVKlCiQjiIxVbONKyO4EU/1ZWwTnvJfmB4mtqgFjqU05waFNOzMUi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.352.0/LICENSE
```

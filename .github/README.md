...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.211.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.211.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M3SsC0rYkdua7pq00uT6F2JB9oiObT3TnVdLyZk9MgT8QymjwVWoFQOBjHO98f27
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.211.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.211.0/index.min.mjs": "sha384-M3SsC0rYkdua7pq00uT6F2JB9oiObT3TnVdLyZk9MgT8QymjwVWoFQOBjHO98f27"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.211.0/LICENSE
```

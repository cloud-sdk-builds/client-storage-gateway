...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.427.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.427.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s1KIP3FMGOCDXZJ3abHUI7KaODYOuYSAcJktwZIAZchAhJg5ov67YF1ATbE+TPLa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.427.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.427.0/index.min.mjs": "sha384-s1KIP3FMGOCDXZJ3abHUI7KaODYOuYSAcJktwZIAZchAhJg5ov67YF1ATbE+TPLa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.427.0/LICENSE
```

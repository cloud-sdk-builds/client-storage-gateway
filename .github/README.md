...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5REC9Tnj4+W+QItZdxJlp+rFNRg00FV85PKblQWwyUB9wtOpktePAt9y3eF6DPbm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.970.0/index.min.mjs": "sha384-5REC9Tnj4+W+QItZdxJlp+rFNRg00FV85PKblQWwyUB9wtOpktePAt9y3eF6DPbm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.970.0/LICENSE
```

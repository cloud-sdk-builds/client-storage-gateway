...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-elpR/YqIock+X9Mj4CNBgXeMt1IAs0SAjSemkj0iL6MDDO8MSa85wqQuB8appHnj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.966.0/index.min.mjs": "sha384-elpR/YqIock+X9Mj4CNBgXeMt1IAs0SAjSemkj0iL6MDDO8MSa85wqQuB8appHnj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.966.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-soYgJIwKM09YP5onZeD6Zs21863nIZQ/iHzQPhl2Z7d1AO8cDh7HTA2W8vrmgx9P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.92.0/index.min.mjs": "sha384-soYgJIwKM09YP5onZeD6Zs21863nIZQ/iHzQPhl2Z7d1AO8cDh7HTA2W8vrmgx9P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.92.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m0/GyvfflZadBnGCbNhTFyXcEhKSrrXBA8zDsDyqmbsQMxDM6cfSAvI5EI+5o1zt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.969.0/index.min.mjs": "sha384-m0/GyvfflZadBnGCbNhTFyXcEhKSrrXBA8zDsDyqmbsQMxDM6cfSAvI5EI+5o1zt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.969.0/LICENSE
```

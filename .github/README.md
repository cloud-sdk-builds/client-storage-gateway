...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+kjMzPuMt2e/TlR0Hhx9jpGRxzhGSgb6jChLD/KTYMN0B8fK+6PMWthyydCm8o0r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.235.0/index.min.mjs": "sha384-+kjMzPuMt2e/TlR0Hhx9jpGRxzhGSgb6jChLD/KTYMN0B8fK+6PMWthyydCm8o0r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.235.0/LICENSE
```

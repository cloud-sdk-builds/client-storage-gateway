...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/nS1eycReu5BpZ1FOppBWRgCSHwAKupK/A3Ru3oBW0qgkMO2O8K50KjeYPpqWXVA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.797.0/index.min.mjs": "sha384-/nS1eycReu5BpZ1FOppBWRgCSHwAKupK/A3Ru3oBW0qgkMO2O8K50KjeYPpqWXVA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.797.0/LICENSE
```

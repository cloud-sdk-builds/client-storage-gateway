...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/tsniFKvEXZRd2y1Gf2XYwk2bzvMJwCg3pY9qHfYUJKOSY3JKqYb0KEvz5LPKOII
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.310.0/index.min.mjs": "sha384-/tsniFKvEXZRd2y1Gf2XYwk2bzvMJwCg3pY9qHfYUJKOSY3JKqYb0KEvz5LPKOII"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.310.0/LICENSE
```

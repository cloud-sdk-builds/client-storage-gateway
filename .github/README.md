...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.614.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.614.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WMl3Nh/BaDZy2scZmIZLk0cR0DGrvkT/pzTpllkLzpRlETZ//6taXCT11j5iWUX5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.614.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.614.0/index.min.mjs": "sha384-WMl3Nh/BaDZy2scZmIZLk0cR0DGrvkT/pzTpllkLzpRlETZ//6taXCT11j5iWUX5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.614.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.215.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.215.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DYKpyM0C0TKHoRQrAKcs6DStmiEuVbjvf/UKX1MusL1FA9slQ3VNL1HdPeVFi7XF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.215.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.215.0/index.min.mjs": "sha384-DYKpyM0C0TKHoRQrAKcs6DStmiEuVbjvf/UKX1MusL1FA9slQ3VNL1HdPeVFi7XF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.215.0/LICENSE
```

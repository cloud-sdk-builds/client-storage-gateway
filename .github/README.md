...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RfFKcJXIA9yinUULKymqCiH8tCQVUB9/cRxt37mi0sMTsbttMb7mrSMojU0jcUXc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.812.0/index.min.mjs": "sha384-RfFKcJXIA9yinUULKymqCiH8tCQVUB9/cRxt37mi0sMTsbttMb7mrSMojU0jcUXc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.812.0/LICENSE
```

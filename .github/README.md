...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tA0Fivp/GMV7KP2Y/ohk01y+1jmyYo8id923pdNFg2BXR5RTEsm61k0opgMhRxYK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.289.0/index.min.mjs": "sha384-tA0Fivp/GMV7KP2Y/ohk01y+1jmyYo8id923pdNFg2BXR5RTEsm61k0opgMhRxYK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.289.0/LICENSE
```

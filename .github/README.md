...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fG6xUttpByPSkzF8kUr0tpI/a96lGL+q9iYmlHITa/f6b7TeX7ERiyg+GdjRTuIR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.774.0/index.min.mjs": "sha384-fG6xUttpByPSkzF8kUr0tpI/a96lGL+q9iYmlHITa/f6b7TeX7ERiyg+GdjRTuIR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.774.0/LICENSE
```

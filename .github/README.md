...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MKfs00C5/aelMfn/QZCTF/d8IpjAjkG3JD1p/OHHJitXBBOMPt/CysrTL5xXpebA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.956.0/index.min.mjs": "sha384-MKfs00C5/aelMfn/QZCTF/d8IpjAjkG3JD1p/OHHJitXBBOMPt/CysrTL5xXpebA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.956.0/LICENSE
```

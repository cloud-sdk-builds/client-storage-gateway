...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1016.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1016.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z+adkUhdzbsb+0P/kHO2Sm6b7WgRutxd0kn6iK+mW0y8Hphr57fFOq7oWg9Z+TXW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1016.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1016.0/index.min.mjs": "sha384-z+adkUhdzbsb+0P/kHO2Sm6b7WgRutxd0kn6iK+mW0y8Hphr57fFOq7oWg9Z+TXW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1016.0/LICENSE
```

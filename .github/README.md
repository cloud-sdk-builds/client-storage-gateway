...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ux1FK/VoJUpihhXG6J8OH3wNUYpkY5Gwddi+CKvU3+CtLYGRUl5SkMQSjg1veL0k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.82.0/index.min.mjs": "sha384-Ux1FK/VoJUpihhXG6J8OH3wNUYpkY5Gwddi+CKvU3+CtLYGRUl5SkMQSjg1veL0k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.82.0/LICENSE
```

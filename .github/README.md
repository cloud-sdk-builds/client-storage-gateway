...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tQ1N2v/pni1fkiZotfGyd4eufXqHq+i7Fqh0DbHNE0tQJxi6Im3BvcRLxUyDTdZG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.17.0/index.min.mjs": "sha384-tQ1N2v/pni1fkiZotfGyd4eufXqHq+i7Fqh0DbHNE0tQJxi6Im3BvcRLxUyDTdZG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.17.0/LICENSE
```

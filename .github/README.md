...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u/yNIzoqAMPvkwmYohf/JQ8W0E53qhkEDbs58ViHyZQD2qL73h3skScsAaaYtPpq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.344.0/index.min.mjs": "sha384-u/yNIzoqAMPvkwmYohf/JQ8W0E53qhkEDbs58ViHyZQD2qL73h3skScsAaaYtPpq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.344.0/LICENSE
```

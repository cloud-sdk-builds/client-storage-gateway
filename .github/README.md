...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NSnt34qtxxxM+XK5hXFW5qn5YfeDkeElqN/rPeLTUJs2Z8NVnvnxGBMv8HepUMj/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.886.0/index.min.mjs": "sha384-NSnt34qtxxxM+XK5hXFW5qn5YfeDkeElqN/rPeLTUJs2Z8NVnvnxGBMv8HepUMj/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.886.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KPkqh3GIDYcFjb6q8GrLwTg6DHCT8yp7sRyV6gBCvkl5qBJ6+zXzJEqSByIJuY8n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.47.0/index.min.mjs": "sha384-KPkqh3GIDYcFjb6q8GrLwTg6DHCT8yp7sRyV6gBCvkl5qBJ6+zXzJEqSByIJuY8n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.47.0/LICENSE
```

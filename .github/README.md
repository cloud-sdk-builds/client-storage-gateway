...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CraChZjJMJnLTb9ihbQwXJzLXyeZBcsekExiJJzr8Ssizv7OY13e8a+8+8qnDZnC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.922.0/index.min.mjs": "sha384-CraChZjJMJnLTb9ihbQwXJzLXyeZBcsekExiJJzr8Ssizv7OY13e8a+8+8qnDZnC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.922.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1003.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1003.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YfnOXwk70j5duNLDdAhYJcZ+rtkHZnxAHvKhs6tx6nqiHKNv/FsOB8p/UkLevygq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1003.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1003.0/index.min.mjs": "sha384-YfnOXwk70j5duNLDdAhYJcZ+rtkHZnxAHvKhs6tx6nqiHKNv/FsOB8p/UkLevygq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1003.0/LICENSE
```

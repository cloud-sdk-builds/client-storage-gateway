...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kdaNSNiKiTMh3Di6WyXXYTgdk4z0xXg6XsB7+/pbQcqVJNjvszENTgfaWmu51IAx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.413.0/index.min.mjs": "sha384-kdaNSNiKiTMh3Di6WyXXYTgdk4z0xXg6XsB7+/pbQcqVJNjvszENTgfaWmu51IAx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.413.0/LICENSE
```

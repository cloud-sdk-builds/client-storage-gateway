...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i8j673PWRZU5GWwus4wUuhX9CNujT3Ukno0U/n241ts/W7oJh+TTydQrFP7q+65Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.22.0/index.min.mjs": "sha384-i8j673PWRZU5GWwus4wUuhX9CNujT3Ukno0U/n241ts/W7oJh+TTydQrFP7q+65Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.22.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fMCyHsF1OwGrClEdr9mBJeW6WT30DWXzJCdhvwypRGsbDy5KmjMQVC/K86KT7GLm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.264.0/index.min.mjs": "sha384-fMCyHsF1OwGrClEdr9mBJeW6WT30DWXzJCdhvwypRGsbDy5KmjMQVC/K86KT7GLm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.264.0/LICENSE
```

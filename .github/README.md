...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cDvc1kfTH0MRJTyfFIvsEA9eopKA63/BkR1RMyL3BwWEcttkgJi+myGlHN2NZx7y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.282.0/index.min.mjs": "sha384-cDvc1kfTH0MRJTyfFIvsEA9eopKA63/BkR1RMyL3BwWEcttkgJi+myGlHN2NZx7y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.282.0/LICENSE
```

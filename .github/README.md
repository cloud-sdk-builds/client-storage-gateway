...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xs0j272MjW2u6WrK/A+y50CAGiGNAJFsXjreSe9/m+s+/hVnRCaCwFxe0X7lebzF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.525.0/index.min.mjs": "sha384-xs0j272MjW2u6WrK/A+y50CAGiGNAJFsXjreSe9/m+s+/hVnRCaCwFxe0X7lebzF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.525.0/LICENSE
```

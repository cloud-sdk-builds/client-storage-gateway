...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ISAOUkJ8wC2E3bIxsgfTJDFkIqODcNsKDRN8f96CAmNXNTNKssRESVjGmYdTgy6J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.925.0/index.min.mjs": "sha384-ISAOUkJ8wC2E3bIxsgfTJDFkIqODcNsKDRN8f96CAmNXNTNKssRESVjGmYdTgy6J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.925.0/LICENSE
```

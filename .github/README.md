...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-L3hmYVHZV9+fuQyGLnkYwFOg4t9ptIvpHrSzSibIZfHrFubVnrevDL/LzDcIFYMU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.118.1/index.min.mjs": "sha384-L3hmYVHZV9+fuQyGLnkYwFOg4t9ptIvpHrSzSibIZfHrFubVnrevDL/LzDcIFYMU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.118.1/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+c5QMqVRwQKQFoE5sbAqoWnrLSgI1kpyd9SQJTsMthzlIDKUuEnQFRPqlI2/PB6J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.58.0/index.min.mjs": "sha384-+c5QMqVRwQKQFoE5sbAqoWnrLSgI1kpyd9SQJTsMthzlIDKUuEnQFRPqlI2/PB6J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.58.0/LICENSE
```

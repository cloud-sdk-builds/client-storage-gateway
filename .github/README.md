...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9s0VGsGSi+EorkouoXeDNx5ivQDZgxOGwdPy7MXsJJ5l3M5gfn6+fYvZRe7LpoPu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.192.0/index.min.mjs": "sha384-9s0VGsGSi+EorkouoXeDNx5ivQDZgxOGwdPy7MXsJJ5l3M5gfn6+fYvZRe7LpoPu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.192.0/LICENSE
```

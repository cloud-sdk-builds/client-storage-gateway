...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0cj16GoXYy//KkX2VycQAa2CHFO7udI1XJf2vVMTwinIBY6Ly/8qHvNdcF3V4l0M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.342.0/index.min.mjs": "sha384-0cj16GoXYy//KkX2VycQAa2CHFO7udI1XJf2vVMTwinIBY6Ly/8qHvNdcF3V4l0M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.342.0/LICENSE
```

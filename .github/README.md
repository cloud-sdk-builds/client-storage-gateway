...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-7GJvyI+ynSC/kEAGz6cpzhcjmN9QMlf4cc3gJbGCDNdPtJaE5CUV4GsLDsIn+bHP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.266.1/index.min.mjs": "sha384-7GJvyI+ynSC/kEAGz6cpzhcjmN9QMlf4cc3gJbGCDNdPtJaE5CUV4GsLDsIn+bHP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.266.1/LICENSE
```

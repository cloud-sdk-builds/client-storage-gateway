...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ca15kcKqKydvhoWHCiOt5tqaIGNCleg1BrWy04WI1MpOZ6K+kmtxfjArA0gL2vDW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.540.0/index.min.mjs": "sha384-ca15kcKqKydvhoWHCiOt5tqaIGNCleg1BrWy04WI1MpOZ6K+kmtxfjArA0gL2vDW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.540.0/LICENSE
```

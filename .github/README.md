...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.80.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.80.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WkV83BuIQpXG+P7oayjaMSGp37Pvu6sm4bb642rsSsHyz4+iaqQnUXm1hU9oUqFw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.80.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.80.0/index.min.mjs": "sha384-WkV83BuIQpXG+P7oayjaMSGp37Pvu6sm4bb642rsSsHyz4+iaqQnUXm1hU9oUqFw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.80.0/LICENSE
```

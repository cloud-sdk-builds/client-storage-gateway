...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.433.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.433.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WeLONtVJ67kNLaGB4LNfNWeJZX8swD4PzyNDZxIfzBNDa/cX9QLUil3zb7njwGij
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.433.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.433.0/index.min.mjs": "sha384-WeLONtVJ67kNLaGB4LNfNWeJZX8swD4PzyNDZxIfzBNDa/cX9QLUil3zb7njwGij"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.433.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Lq9xGhZConssDIW6guQPr61+OblpphzD7EXuawDzuKOl0aSFsqS+gkCwEGrIPmhO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.315.0/index.min.mjs": "sha384-Lq9xGhZConssDIW6guQPr61+OblpphzD7EXuawDzuKOl0aSFsqS+gkCwEGrIPmhO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.315.0/LICENSE
```

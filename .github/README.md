...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YSb1nLYOVKGJv9bJNwgv9ba0eLuIffBXyNKeOdQE3RlaSNPLtQ1gf1p/VebA6fXS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.299.0/index.min.mjs": "sha384-YSb1nLYOVKGJv9bJNwgv9ba0eLuIffBXyNKeOdQE3RlaSNPLtQ1gf1p/VebA6fXS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.299.0/LICENSE
```

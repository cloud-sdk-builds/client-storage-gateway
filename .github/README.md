...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ncUb0mrFLSppoJEloEnqSD/9q6mRZ0F0Cb0Qcv9CK+reson5jz4gVLTCazhQjNtp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.28.0/index.min.mjs": "sha384-ncUb0mrFLSppoJEloEnqSD/9q6mRZ0F0Cb0Qcv9CK+reson5jz4gVLTCazhQjNtp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.28.0/LICENSE
```

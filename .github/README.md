...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L/G761oLV1PtrKsafytqpgnJ6aYSWYWw2gXdFnAlfYNs+mPQ0wz7LL3BUvKEGCxZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.142.0/index.min.mjs": "sha384-L/G761oLV1PtrKsafytqpgnJ6aYSWYWw2gXdFnAlfYNs+mPQ0wz7LL3BUvKEGCxZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.142.0/LICENSE
```

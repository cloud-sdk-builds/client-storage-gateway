...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gBqISA6odQu0sG8EhC/iO7eFdOh3yLM3ysyfJlWh6hPRKHuqroH9ykoAaSwvAGkT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.74.0/index.min.mjs": "sha384-gBqISA6odQu0sG8EhC/iO7eFdOh3yLM3ysyfJlWh6hPRKHuqroH9ykoAaSwvAGkT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.74.0/LICENSE
```

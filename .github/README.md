...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OeGcVN7d6QbQxqKMhstkzhnPNHoMbP5r7xKnpoOhWr2amWgk2mJoT9yAAoFx6WAz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.9.0/index.min.mjs": "sha384-OeGcVN7d6QbQxqKMhstkzhnPNHoMbP5r7xKnpoOhWr2amWgk2mJoT9yAAoFx6WAz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.9.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.438.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.438.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZdJjzcPQr+yHdswxnamWDLbE2TcpDegMCX1L5oFF1GOx14zVcOGcfL6PMXCiwMX6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.438.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.438.0/index.min.mjs": "sha384-ZdJjzcPQr+yHdswxnamWDLbE2TcpDegMCX1L5oFF1GOx14zVcOGcfL6PMXCiwMX6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.438.0/LICENSE
```

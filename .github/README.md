...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dC+p8p601w4Iwz6LT+6G1Wf7GotkG7zaHUagzg0j6kfFt5aKcyEN34rPfFykKQ8h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.329.0/index.min.mjs": "sha384-dC+p8p601w4Iwz6LT+6G1Wf7GotkG7zaHUagzg0j6kfFt5aKcyEN34rPfFykKQ8h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.329.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.891.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.891.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KlqiLewd0giuN/lsTFhYYI0p45EnHflof8dSNzS9L/p4aUePV5ZmjzIdBAFg0b5E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.891.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.891.0/index.min.mjs": "sha384-KlqiLewd0giuN/lsTFhYYI0p45EnHflof8dSNzS9L/p4aUePV5ZmjzIdBAFg0b5E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.891.0/LICENSE
```

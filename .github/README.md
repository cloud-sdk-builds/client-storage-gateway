...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HM4SUh2sCPkIZ4+zTxL41Ec9wEsR0QHs30UXV6DLl4lFZ2bSnRy2e2AzXuUU61Dz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.984.0/index.min.mjs": "sha384-HM4SUh2sCPkIZ4+zTxL41Ec9wEsR0QHs30UXV6DLl4lFZ2bSnRy2e2AzXuUU61Dz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.984.0/LICENSE
```

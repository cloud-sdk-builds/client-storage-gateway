...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.5.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.5.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PhLl33PnTS9WqCkk24oRY1X3TRbFv+QvBZ6Zq/zzs9GhE25iVQKOv5wdhUBgwuAI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.5.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.5.0/index.min.mjs": "sha384-PhLl33PnTS9WqCkk24oRY1X3TRbFv+QvBZ6Zq/zzs9GhE25iVQKOv5wdhUBgwuAI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.5.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xuKk1LjlsOUANt9WftEAJkX84MJ/vLs1QY9/fNOw2lDzyzEIgpvdj6rSjXkgcoRA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.473.0/index.min.mjs": "sha384-xuKk1LjlsOUANt9WftEAJkX84MJ/vLs1QY9/fNOw2lDzyzEIgpvdj6rSjXkgcoRA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.473.0/LICENSE
```

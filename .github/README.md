...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y4L7x5lGQk+8p7IJ+o9WltguAKSMPFMZ9GieCqPP8JS5KIvEl3kRfLGDrbLD5AzB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.948.0/index.min.mjs": "sha384-y4L7x5lGQk+8p7IJ+o9WltguAKSMPFMZ9GieCqPP8JS5KIvEl3kRfLGDrbLD5AzB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.948.0/LICENSE
```

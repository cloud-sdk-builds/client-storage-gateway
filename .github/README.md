...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ObFuxe5NWMIIGWtpbenN+M8trgiAFL4iQ947CsvktG2hdz6FlfpMK0DLbsRbLgUz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.817.0/index.min.mjs": "sha384-ObFuxe5NWMIIGWtpbenN+M8trgiAFL4iQ947CsvktG2hdz6FlfpMK0DLbsRbLgUz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.817.0/LICENSE
```

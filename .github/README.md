...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1wYnF4r8+MBTECJPE0uo+hL8Nck5xF2oKfOuP3akwN10ucfjkIjurcDOL4suJtVt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.20.0/index.min.mjs": "sha384-1wYnF4r8+MBTECJPE0uo+hL8Nck5xF2oKfOuP3akwN10ucfjkIjurcDOL4suJtVt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.20.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.180.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.180.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OpxwCWeeKgfw3OJzyPbb7/HdfgAIVom0qfJTEDTl+D44ZxboRd0wCer9dEX8DsPo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.180.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.180.0/index.min.mjs": "sha384-OpxwCWeeKgfw3OJzyPbb7/HdfgAIVom0qfJTEDTl+D44ZxboRd0wCer9dEX8DsPo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.180.0/LICENSE
```

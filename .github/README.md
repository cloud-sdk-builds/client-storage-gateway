...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ym/9AmnxnCJcW4hP4w9VT/Gv5EjaCTJgX2xCUec/NXAmfV4L2Et0xBjShMAzhlWb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.435.0/index.min.mjs": "sha384-Ym/9AmnxnCJcW4hP4w9VT/Gv5EjaCTJgX2xCUec/NXAmfV4L2Et0xBjShMAzhlWb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.435.0/LICENSE
```

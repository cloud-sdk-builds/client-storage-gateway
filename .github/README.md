...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PR5QoQqT7nfwD6rLQqhbTMPc1XCWwhzu3J/wJOSpjuRVH+rdurw1xDJiecDNFkzY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.484.0/index.min.mjs": "sha384-PR5QoQqT7nfwD6rLQqhbTMPc1XCWwhzu3J/wJOSpjuRVH+rdurw1xDJiecDNFkzY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.484.0/LICENSE
```

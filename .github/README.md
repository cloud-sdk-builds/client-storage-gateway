...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9p+Xocxxdqg1mhnin3JvPSYXM/ZKNr/EoOiij3K7vKiPt47nL10Wl+Z9j+n/Nebe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.478.0/index.min.mjs": "sha384-9p+Xocxxdqg1mhnin3JvPSYXM/ZKNr/EoOiij3K7vKiPt47nL10Wl+Z9j+n/Nebe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.478.0/LICENSE
```

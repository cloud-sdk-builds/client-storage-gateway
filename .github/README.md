...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7Us9T+CXuOWJPUzcpC02jky0EQZyfUYMguLoBJw6xydL3SxYTWWWb1Haj+V4QJSV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.204.0/index.min.mjs": "sha384-7Us9T+CXuOWJPUzcpC02jky0EQZyfUYMguLoBJw6xydL3SxYTWWWb1Haj+V4QJSV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.204.0/LICENSE
```

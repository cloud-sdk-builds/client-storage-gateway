...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lkrWcmHrzMmhBpQP9qPLQ6soocudknHVQ/ONH7s9+5Q5GkH8rKzO/coJZ+a7yRe6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.369.0/index.min.mjs": "sha384-lkrWcmHrzMmhBpQP9qPLQ6soocudknHVQ/ONH7s9+5Q5GkH8rKzO/coJZ+a7yRe6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.369.0/LICENSE
```

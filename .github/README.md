...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-fwD4T8fKcmOb/krfLXI/5/GhMR7OPNA4qSILDY7nhcA/zynQfOOplayipq7vjUWq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.731.1/index.min.mjs": "sha384-fwD4T8fKcmOb/krfLXI/5/GhMR7OPNA4qSILDY7nhcA/zynQfOOplayipq7vjUWq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.731.1/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WjEJ3qIBKJC+Mni/nw2i1MNc/9ZYBzCjIL7vVVfs/jTrJrjhxQTFSWTRyNuwXoE8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.496.0/index.min.mjs": "sha384-WjEJ3qIBKJC+Mni/nw2i1MNc/9ZYBzCjIL7vVVfs/jTrJrjhxQTFSWTRyNuwXoE8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.496.0/LICENSE
```

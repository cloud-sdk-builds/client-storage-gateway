...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vEVtazZlUyQWqLI4ZusCtby3CXIEzSf/Hs6I1u0k2jqmfOjzL/wjSqHa+siNa6D5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.835.0/index.min.mjs": "sha384-vEVtazZlUyQWqLI4ZusCtby3CXIEzSf/Hs6I1u0k2jqmfOjzL/wjSqHa+siNa6D5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.835.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W4pr/KnyFJwYvVJSDCmcng09bj4a/7fHcSq98wueSK65pUHC6Zy0wWEO/4kKTw6H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.179.0/index.min.mjs": "sha384-W4pr/KnyFJwYvVJSDCmcng09bj4a/7fHcSq98wueSK65pUHC6Zy0wWEO/4kKTw6H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.179.0/LICENSE
```

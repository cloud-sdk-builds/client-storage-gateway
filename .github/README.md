...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UdIGh2SwRy5782OFcCRjvhKTU2CcPUEU0+0mqzpLXxhb5YD3OD3TaWfjyhq7dA3/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.0.0/index.min.mjs": "sha384-UdIGh2SwRy5782OFcCRjvhKTU2CcPUEU0+0mqzpLXxhb5YD3OD3TaWfjyhq7dA3/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.0.0/LICENSE
```

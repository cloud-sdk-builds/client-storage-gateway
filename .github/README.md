...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y6Rs1ZulwvgI4y0AC0JWr4pC+vif2RGpyUS6Ek+fbYcIjuj5RUwjcGtLQBoWCTnm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.664.0/index.min.mjs": "sha384-y6Rs1ZulwvgI4y0AC0JWr4pC+vif2RGpyUS6Ek+fbYcIjuj5RUwjcGtLQBoWCTnm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.664.0/LICENSE
```

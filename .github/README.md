...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T7l7TBb3C6mN7F0SYrnoPe5NPY2N2o+blmGPNE1H5ZhfqxksABkWAA7bMvxgGcla
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.971.0/index.min.mjs": "sha384-T7l7TBb3C6mN7F0SYrnoPe5NPY2N2o+blmGPNE1H5ZhfqxksABkWAA7bMvxgGcla"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.971.0/LICENSE
```

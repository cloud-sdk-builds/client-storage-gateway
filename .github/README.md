...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lx6Cd6gUO7okozZ/t0f3z1Tx/O0RXYbRH23iukdCQbyTksT7F7+UEvcnook0w1n7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.913.0/index.min.mjs": "sha384-lx6Cd6gUO7okozZ/t0f3z1Tx/O0RXYbRH23iukdCQbyTksT7F7+UEvcnook0w1n7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.913.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+mQc5OkLxn+dP0cU8t/7G5dw3TIVdNOFYomM46NQhaVryU4bBg4QEaRdhEXxQ6L9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.112.0/index.min.mjs": "sha384-+mQc5OkLxn+dP0cU8t/7G5dw3TIVdNOFYomM46NQhaVryU4bBg4QEaRdhEXxQ6L9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.112.0/LICENSE
```

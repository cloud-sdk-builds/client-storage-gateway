...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MwdBkQU7LXLA2R8Y9DuIF4oYlkjrzoD5RM4evjJTNBu2SC2a0Yeotq4FDkGeHyOr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.288.0/index.min.mjs": "sha384-MwdBkQU7LXLA2R8Y9DuIF4oYlkjrzoD5RM4evjJTNBu2SC2a0Yeotq4FDkGeHyOr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.288.0/LICENSE
```

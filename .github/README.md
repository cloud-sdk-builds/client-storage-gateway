...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LI6TMoGPvEY08XOAncxwom4zMaGqnd0F3mWTSdU44oiLEq3XGZNKI/CHKIZXg5Hz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.350.0/index.min.mjs": "sha384-LI6TMoGPvEY08XOAncxwom4zMaGqnd0F3mWTSdU44oiLEq3XGZNKI/CHKIZXg5Hz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.350.0/LICENSE
```

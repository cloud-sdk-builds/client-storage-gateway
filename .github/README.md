...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ltvPD3tNRtsUC0HrvjncAG5/1cYTpm3ahdss0HEjVrSxOLOwIEe/s6KBerh2OHQT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.921.0/index.min.mjs": "sha384-ltvPD3tNRtsUC0HrvjncAG5/1cYTpm3ahdss0HEjVrSxOLOwIEe/s6KBerh2OHQT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.921.0/LICENSE
```

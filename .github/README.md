...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-agSKndBFt7cWHYK5NXv7kCIgJ2D7x7rRv9PiTV3koNTVfZQmMTzYGfzdl1MU/Ibm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.991.0/index.min.mjs": "sha384-agSKndBFt7cWHYK5NXv7kCIgJ2D7x7rRv9PiTV3koNTVfZQmMTzYGfzdl1MU/Ibm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.991.0/LICENSE
```

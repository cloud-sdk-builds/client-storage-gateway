...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NjEzP47Rv5WPxWMB4gDoxpRKq+DOstPCRaAkQ4l9d5p08Ev1RaHmLP1h5Oksk52u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.347.0/index.min.mjs": "sha384-NjEzP47Rv5WPxWMB4gDoxpRKq+DOstPCRaAkQ4l9d5p08Ev1RaHmLP1h5Oksk52u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.347.0/LICENSE
```

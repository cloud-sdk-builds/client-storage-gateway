...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7mkK8lGGk0SblsZBhkCXJ9aFpunwHEMNYJCGdcASpA/EYz4VTvvlZ/T8Ak5rumaC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.178.0/index.min.mjs": "sha384-7mkK8lGGk0SblsZBhkCXJ9aFpunwHEMNYJCGdcASpA/EYz4VTvvlZ/T8Ak5rumaC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.178.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m9Xv+OG5m1QRZHZCnvVVLRJ44QUXISg2CBH9pYXkKkh/LNRhPt9dOu3OcRkeV8To
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.514.0/index.min.mjs": "sha384-m9Xv+OG5m1QRZHZCnvVVLRJ44QUXISg2CBH9pYXkKkh/LNRhPt9dOu3OcRkeV8To"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.514.0/LICENSE
```

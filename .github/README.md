...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qHY2Jt6IVosJQhXcsu7Y+ML+Fxa/UmOO0udI2wEw2vPv24xFIwFaM9ojpgPq9h7L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.908.0/index.min.mjs": "sha384-qHY2Jt6IVosJQhXcsu7Y+ML+Fxa/UmOO0udI2wEw2vPv24xFIwFaM9ojpgPq9h7L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.908.0/LICENSE
```

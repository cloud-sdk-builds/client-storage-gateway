...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.30.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.30.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kVM61+ueEA7CP449Y4cMZaI+jsXAqFc78gk2cPkdpxO0aBZzxdVRIO2TxCtOA2Yy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.30.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.30.0/index.min.mjs": "sha384-kVM61+ueEA7CP449Y4cMZaI+jsXAqFc78gk2cPkdpxO0aBZzxdVRIO2TxCtOA2Yy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.30.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rgJf7v62K5mYuydtQrCbwd3aawg1XtAsIDs3Nv3+q7u94ARoV5/Jnu2fPLm0Y7pL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.200.0/index.min.mjs": "sha384-rgJf7v62K5mYuydtQrCbwd3aawg1XtAsIDs3Nv3+q7u94ARoV5/Jnu2fPLm0Y7pL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.200.0/LICENSE
```

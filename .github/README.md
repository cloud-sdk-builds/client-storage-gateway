...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l+VM7aqQ8CYQEPG+Nb7OdiAmevXR+4OT9dFxYvC/mSbk0Jr22dQgbtEdcixTW2Lx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.873.0/index.min.mjs": "sha384-l+VM7aqQ8CYQEPG+Nb7OdiAmevXR+4OT9dFxYvC/mSbk0Jr22dQgbtEdcixTW2Lx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.873.0/LICENSE
```

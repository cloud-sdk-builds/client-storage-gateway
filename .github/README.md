...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kDIj4qpOH8DBR8hg4e2xNP9FqdHI7/D3dCcyzj5O+6DYY/fmaocfCoDNcKIxPhX0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.338.0/index.min.mjs": "sha384-kDIj4qpOH8DBR8hg4e2xNP9FqdHI7/D3dCcyzj5O+6DYY/fmaocfCoDNcKIxPhX0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.338.0/LICENSE
```

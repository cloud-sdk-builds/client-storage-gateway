...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.862.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.862.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jFzA4fs5juRH7zrRJgAdXgKy1vvlnDJiOFHMDfE6VbZVBz0UTUO88Z/wk3llxQTg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.862.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.862.0/index.min.mjs": "sha384-jFzA4fs5juRH7zrRJgAdXgKy1vvlnDJiOFHMDfE6VbZVBz0UTUO88Z/wk3llxQTg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.862.0/LICENSE
```

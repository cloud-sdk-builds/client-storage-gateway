...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a4nrOjx/9qQDCUQoq8teIdHc+CfKRuCGzjmuVaGg85Ydut8pazks3gL2S0ZttCgB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.592.0/index.min.mjs": "sha384-a4nrOjx/9qQDCUQoq8teIdHc+CfKRuCGzjmuVaGg85Ydut8pazks3gL2S0ZttCgB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.592.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2NKME9a6H3rD5a2tx59AqGcgI/vcwuraVKPxsBeN+cykvWy0LUuTpFMxLPn2ZtBF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.127.0/index.min.mjs": "sha384-2NKME9a6H3rD5a2tx59AqGcgI/vcwuraVKPxsBeN+cykvWy0LUuTpFMxLPn2ZtBF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.127.0/LICENSE
```

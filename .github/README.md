...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-sH0l7LSsPipEAQ2rIoDBI70xTem7+5rXA/VQcFZa+nU+hHQl+BhPeKKuDwv2jZ7t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.54.1/index.min.mjs": "sha384-sH0l7LSsPipEAQ2rIoDBI70xTem7+5rXA/VQcFZa+nU+hHQl+BhPeKKuDwv2jZ7t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.54.1/LICENSE
```

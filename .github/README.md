...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L9JNhZWLFGYeah93CRVs/A6gfbfY7ppzUQkfmCwsK/+zFo0NdprRuUNDhLn5j+ya
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.326.0/index.min.mjs": "sha384-L9JNhZWLFGYeah93CRVs/A6gfbfY7ppzUQkfmCwsK/+zFo0NdprRuUNDhLn5j+ya"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.326.0/LICENSE
```

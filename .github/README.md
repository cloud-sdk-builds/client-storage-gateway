...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NTT2ceeEYw8pVNWkH9I+e83XH8y1Uo+inxA6hp9JqZrNrwgnLzrziKs+Eco1PAsM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.575.0/index.min.mjs": "sha384-NTT2ceeEYw8pVNWkH9I+e83XH8y1Uo+inxA6hp9JqZrNrwgnLzrziKs+Eco1PAsM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.575.0/LICENSE
```

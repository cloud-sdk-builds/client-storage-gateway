...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.511.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.511.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QtOQPxC3fWnthCEG9gbydRiytQhEvymEW2wydLOoLX3e1lpEF7gzXYNkF4jz5ZYv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.511.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.511.0/index.min.mjs": "sha384-QtOQPxC3fWnthCEG9gbydRiytQhEvymEW2wydLOoLX3e1lpEF7gzXYNkF4jz5ZYv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.511.0/LICENSE
```

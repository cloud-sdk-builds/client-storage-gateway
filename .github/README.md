...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FjVpG/vQVzjpfOefXN1ep8zOF6X+gaLABKim5L+smLIc7lHQcZ5FwNsdqnZjOFBA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.451.0/index.min.mjs": "sha384-FjVpG/vQVzjpfOefXN1ep8zOF6X+gaLABKim5L+smLIc7lHQcZ5FwNsdqnZjOFBA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.451.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GJCxzjjoqUzHoRuOdlwuqg7oA1IKJkkC4KVnzd+EH1009IigWq2d46kxj6JZQPx5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.409.0/index.min.mjs": "sha384-GJCxzjjoqUzHoRuOdlwuqg7oA1IKJkkC4KVnzd+EH1009IigWq2d46kxj6JZQPx5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.409.0/LICENSE
```

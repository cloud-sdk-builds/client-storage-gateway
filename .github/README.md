...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.6.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.6.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CTgGQVHP84b6Upb8HR8oR7Lm7hlIZB8duCgSX5UczoOeP66OcgEOBggYiqQ3kkKy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.6.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.6.0/index.min.mjs": "sha384-CTgGQVHP84b6Upb8HR8oR7Lm7hlIZB8duCgSX5UczoOeP66OcgEOBggYiqQ3kkKy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.6.0/LICENSE
```

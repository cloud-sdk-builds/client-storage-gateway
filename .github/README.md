...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BmarfQ4OvZX5chhdafPiinA5kOex9mqLSutwvqdO3JKqpIiMcqJEEITRJCAkTQ1g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.24.0/index.min.mjs": "sha384-BmarfQ4OvZX5chhdafPiinA5kOex9mqLSutwvqdO3JKqpIiMcqJEEITRJCAkTQ1g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.24.0/LICENSE
```

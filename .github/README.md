...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zU3WMH60/22FWALmFqJ1HIqSmCqZJ7ieyv/nRCv+Kyt+nFRNqhHFWIetJVD4/3z+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.405.0/index.min.mjs": "sha384-zU3WMH60/22FWALmFqJ1HIqSmCqZJ7ieyv/nRCv+Kyt+nFRNqhHFWIetJVD4/3z+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.405.0/LICENSE
```

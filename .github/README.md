...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cY7+VzMog8OAOtCP662pEWliB2T8lwLJogxtjjiy67xQfSxo38353b0clEiDbJX8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.50.0/index.min.mjs": "sha384-cY7+VzMog8OAOtCP662pEWliB2T8lwLJogxtjjiy67xQfSxo38353b0clEiDbJX8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.50.0/LICENSE
```

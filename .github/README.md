...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jpxC5mz/hRqqL7rTDUCFtGgFmWoWc1Aw5A8mLVFzeE8mWyR1l9qN4tVpPrnb7t+u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.928.0/index.min.mjs": "sha384-jpxC5mz/hRqqL7rTDUCFtGgFmWoWc1Aw5A8mLVFzeE8mWyR1l9qN4tVpPrnb7t+u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.928.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hhr4BSK4aNnftUgkPxp+VaUwwRKBg+bc+IGwPAxx4PjlQd+NiEJ5R9LPcJiX8KOe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.916.0/index.min.mjs": "sha384-hhr4BSK4aNnftUgkPxp+VaUwwRKBg+bc+IGwPAxx4PjlQd+NiEJ5R9LPcJiX8KOe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.916.0/LICENSE
```

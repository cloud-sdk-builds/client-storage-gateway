...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TPN8/O/MEehE3PZSGi7rTJFBV7vN/nOQZnOSzj+l0hwR7qx/BACNsrAPqM2f+qp+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.606.0/index.min.mjs": "sha384-TPN8/O/MEehE3PZSGi7rTJFBV7vN/nOQZnOSzj+l0hwR7qx/BACNsrAPqM2f+qp+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.606.0/LICENSE
```

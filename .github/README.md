...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.1026.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1026.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/v8PpCccjUeTp6/6bpGjS1rbCV4yHOd+9fPzEw+hhtJ74xmyXWDO0ynEa7dmjtDh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1026.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.1026.0/index.min.mjs": "sha384-/v8PpCccjUeTp6/6bpGjS1rbCV4yHOd+9fPzEw+hhtJ74xmyXWDO0ynEa7dmjtDh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.1026.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZWZFjU3x+AGqQ6dLAMiAkkbG4oSO5GzI5AZST6+Fv0FQYZpJnUqdGZoicRKrgDvb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.521.0/index.min.mjs": "sha384-ZWZFjU3x+AGqQ6dLAMiAkkbG4oSO5GzI5AZST6+Fv0FQYZpJnUqdGZoicRKrgDvb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.521.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XAo8nR0vvCkV6VmLKCvBb4S2MJ2PKwTVD8hk4ySf3kCu/kE2pnvVENwBSrS3eTwZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.327.0/index.min.mjs": "sha384-XAo8nR0vvCkV6VmLKCvBb4S2MJ2PKwTVD8hk4ySf3kCu/kE2pnvVENwBSrS3eTwZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.327.0/LICENSE
```

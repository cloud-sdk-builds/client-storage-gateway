...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-VWLuGrcbGJ4QDU329Cj5BMbu6fIfW3VmXcqjU62faUH88eeP/1vlTJCmPG7p8OsW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.347.1/index.min.mjs": "sha384-VWLuGrcbGJ4QDU329Cj5BMbu6fIfW3VmXcqjU62faUH88eeP/1vlTJCmPG7p8OsW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.347.1/LICENSE
```

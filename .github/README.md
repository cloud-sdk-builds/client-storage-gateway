...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3b+xcJPC1bbcktTmIoNBLpz4SZN5dOVdDvaNCktOVFFd1wkgx+MOTijhN8QPtW5e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.798.0/index.min.mjs": "sha384-3b+xcJPC1bbcktTmIoNBLpz4SZN5dOVdDvaNCktOVFFd1wkgx+MOTijhN8QPtW5e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.798.0/LICENSE
```

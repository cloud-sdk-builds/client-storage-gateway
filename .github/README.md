...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CRFL7Y3j4ANoy3iEnElEk5iTfQr1Nls78ymCRLqkFKJkAR0nTsgou+rfkc6SydIt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.202.0/index.min.mjs": "sha384-CRFL7Y3j4ANoy3iEnElEk5iTfQr1Nls78ymCRLqkFKJkAR0nTsgou+rfkc6SydIt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.202.0/LICENSE
```

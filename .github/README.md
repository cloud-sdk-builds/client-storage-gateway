...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.565.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.565.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-16xEmHExz7EsX1FxQ4CG98gi4pqmHxt2Ik8rmPwAetJeug0jqTre+cyo0iHWV0oN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.565.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.565.0/index.min.mjs": "sha384-16xEmHExz7EsX1FxQ4CG98gi4pqmHxt2Ik8rmPwAetJeug0jqTre+cyo0iHWV0oN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.565.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g7AM5NaUQ912uEeRtYVgQF+jLrqVrRuqvEJPEeEM8QLnWDCPpmVkMnrt22YMTJU/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.887.0/index.min.mjs": "sha384-g7AM5NaUQ912uEeRtYVgQF+jLrqVrRuqvEJPEeEM8QLnWDCPpmVkMnrt22YMTJU/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.887.0/LICENSE
```

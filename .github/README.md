...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8HbQcKYSub6FmrWvuvOln8GtAMZZs+45QQeUR1m32XLW7EdRbZRs1dS33X8A3aAR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.549.0/index.min.mjs": "sha384-8HbQcKYSub6FmrWvuvOln8GtAMZZs+45QQeUR1m32XLW7EdRbZRs1dS33X8A3aAR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.549.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.4.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.4.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HhMYKgqk42jd6S2ig1SsDhC5J7KySFSAFyuNCf31dyeJ64+5VJUPqve3QIgzfxko
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.4.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.4.0/index.min.mjs": "sha384-HhMYKgqk42jd6S2ig1SsDhC5J7KySFSAFyuNCf31dyeJ64+5VJUPqve3QIgzfxko"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.4.0/LICENSE
```

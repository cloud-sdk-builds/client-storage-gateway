...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R4rnOeOPC9seKoJ3VJNA3H1I6owRUu0tvD1driJzDhyRARdv+ynVEWCN5sPpD+xf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.370.0/index.min.mjs": "sha384-R4rnOeOPC9seKoJ3VJNA3H1I6owRUu0tvD1driJzDhyRARdv+ynVEWCN5sPpD+xf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.370.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5KmmKcya6azPyWQ+lnqURIWCTv8tarRE3NkAwi0UZvKIsY6IppA9fbv8NVoFSoox
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.55.0/index.min.mjs": "sha384-5KmmKcya6azPyWQ+lnqURIWCTv8tarRE3NkAwi0UZvKIsY6IppA9fbv8NVoFSoox"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.55.0/LICENSE
```

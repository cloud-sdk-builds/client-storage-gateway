...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.651.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.651.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-edsUzidLo7rrlMruagxyyh0XMlbEHc35h5+wz9llZYPLuA5Q7jqjISEfxlBZfjtT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.651.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.651.0/index.min.mjs": "sha384-edsUzidLo7rrlMruagxyyh0XMlbEHc35h5+wz9llZYPLuA5Q7jqjISEfxlBZfjtT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.651.0/LICENSE
```

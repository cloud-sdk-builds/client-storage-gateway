...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m+MN5PsMnEBZuVKwJavIe9uRTgBX/Zqa8YsSsLyWHOG8Ao/Lk8AAcDUSq3XXw/r2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.934.0/index.min.mjs": "sha384-m+MN5PsMnEBZuVKwJavIe9uRTgBX/Zqa8YsSsLyWHOG8Ao/Lk8AAcDUSq3XXw/r2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.934.0/LICENSE
```

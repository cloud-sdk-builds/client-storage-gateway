...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tSETGzaPpvuC1owgrmIVg1Ko+RS4dtB0gsHvNF7B/ZPmBolZlH44rhbnKEE6/Uja
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.105.0/index.min.mjs": "sha384-tSETGzaPpvuC1owgrmIVg1Ko+RS4dtB0gsHvNF7B/ZPmBolZlH44rhbnKEE6/Uja"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.105.0/LICENSE
```

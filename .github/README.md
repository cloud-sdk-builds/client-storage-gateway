...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DedwYjyguiYHeIpbeQJI5smSidNBvo0bPSK563B6P+mJFiYO01ry6E4/FARGNxtU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.359.0/index.min.mjs": "sha384-DedwYjyguiYHeIpbeQJI5smSidNBvo0bPSK563B6P+mJFiYO01ry6E4/FARGNxtU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.359.0/LICENSE
```

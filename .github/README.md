...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.430.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.430.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HOWcGtJzHpTehQyuAoEiaj7BtmRTtCLg3TFIquRwJvl4tpE0ft4Jb+p2L/rdnppm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.430.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.430.0/index.min.mjs": "sha384-HOWcGtJzHpTehQyuAoEiaj7BtmRTtCLg3TFIquRwJvl4tpE0ft4Jb+p2L/rdnppm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.430.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.669.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.669.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WjNfs4yZpt7xyvoNt37z18FXruTJjzcciWO9wNt3QCLPwsRNf+KJ3bzBMLc1GYKa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.669.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.669.0/index.min.mjs": "sha384-WjNfs4yZpt7xyvoNt37z18FXruTJjzcciWO9wNt3QCLPwsRNf+KJ3bzBMLc1GYKa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.669.0/LICENSE
```

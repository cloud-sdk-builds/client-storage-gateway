...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UBaBWAy2A2VcVpBdqjPsT1ptxeTQgHy1N5bevoeWCm6UQ8SQdBLDUnKXqmzwSDcw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.212.0/index.min.mjs": "sha384-UBaBWAy2A2VcVpBdqjPsT1ptxeTQgHy1N5bevoeWCm6UQ8SQdBLDUnKXqmzwSDcw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.212.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HBejJ7ralmbJJB2gbR3iLkmSPR+Ikw9rog0O2DsWUWtZAAyn7vNRlI+2n4KE34Al
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.726.0/index.min.mjs": "sha384-HBejJ7ralmbJJB2gbR3iLkmSPR+Ikw9rog0O2DsWUWtZAAyn7vNRlI+2n4KE34Al"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.726.0/LICENSE
```

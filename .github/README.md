...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kDAWLWQHv9iFh8Rjk5aigi+CBJmiZgzfEzPFhGKr/EPIl7I5IaZVaSy7vuogcZAq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.41.0/index.min.mjs": "sha384-kDAWLWQHv9iFh8Rjk5aigi+CBJmiZgzfEzPFhGKr/EPIl7I5IaZVaSy7vuogcZAq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.41.0/LICENSE
```

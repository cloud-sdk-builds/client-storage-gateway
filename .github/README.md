...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dsu3bJBVAtraj5H1WC67hR3t8MKMgVLcE++Zn5jtWXxGm3YssX7nZDLiUhIK705j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.223.0/index.min.mjs": "sha384-dsu3bJBVAtraj5H1WC67hR3t8MKMgVLcE++Zn5jtWXxGm3YssX7nZDLiUhIK705j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.223.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.568.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.568.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fCzX9A9Wg6szYrJbQu3ijQobqIwhLZdzZkcVOOC6Xl3CXrEQCKfy3+7iNsYA2RZE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.568.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.568.0/index.min.mjs": "sha384-fCzX9A9Wg6szYrJbQu3ijQobqIwhLZdzZkcVOOC6Xl3CXrEQCKfy3+7iNsYA2RZE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.568.0/LICENSE
```

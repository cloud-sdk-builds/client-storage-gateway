...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8GVQg9+lLaNq+z4nVlZD++3CjXKb+ok/EyGp2gTnCxJoPP9Xe8gb4UIfa2o/rL9K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.749.0/index.min.mjs": "sha384-8GVQg9+lLaNq+z4nVlZD++3CjXKb+ok/EyGp2gTnCxJoPP9Xe8gb4UIfa2o/rL9K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.749.0/LICENSE
```

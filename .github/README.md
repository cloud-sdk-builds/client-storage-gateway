...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5Zs4bjGJz7fsiVTqaHP+nbGmztNo2FSDxVxwEjU/jLZf6qSOxZYCYb1mih6t5nyf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.845.0/index.min.mjs": "sha384-5Zs4bjGJz7fsiVTqaHP+nbGmztNo2FSDxVxwEjU/jLZf6qSOxZYCYb1mih6t5nyf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.845.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.581.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.581.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eXXiOIBy/8DMAu/54mB9507p30PPGz/pWHzVjQPwC3OvHJRoQ3KqrbwEWbpFchLo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.581.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.581.0/index.min.mjs": "sha384-eXXiOIBy/8DMAu/54mB9507p30PPGz/pWHzVjQPwC3OvHJRoQ3KqrbwEWbpFchLo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.581.0/LICENSE
```

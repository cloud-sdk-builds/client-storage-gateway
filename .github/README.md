...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q+yokH9Bl/OEWpgsDdNL7fs4vi+ChK3+vXW3WtICeonAKmwBt5nnYS8SCu6tl1uP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.709.0/index.min.mjs": "sha384-q+yokH9Bl/OEWpgsDdNL7fs4vi+ChK3+vXW3WtICeonAKmwBt5nnYS8SCu6tl1uP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.709.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OvedDZf8a7DsGH+nbI/iwUAMIrdi11xN+th7sYfEbeUUIoIfvx7nbtgClTL7JBQt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.193.0/index.min.mjs": "sha384-OvedDZf8a7DsGH+nbI/iwUAMIrdi11xN+th7sYfEbeUUIoIfvx7nbtgClTL7JBQt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.193.0/LICENSE
```

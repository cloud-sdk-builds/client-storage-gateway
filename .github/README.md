...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zWSt+SGF1fsvy0QsoMc3wcBz7eJAToWcvjbBnSmz55OQuRZ+J0FFQPgec988jvuk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.624.0/index.min.mjs": "sha384-zWSt+SGF1fsvy0QsoMc3wcBz7eJAToWcvjbBnSmz55OQuRZ+J0FFQPgec988jvuk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.624.0/LICENSE
```

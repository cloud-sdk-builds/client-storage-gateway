...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6AG7YdjBLDpReRffDoqq3EekCbNiWl7ShtEXWQPF845q+fcDjGzgqIyJ2/CF6tJJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.552.0/index.min.mjs": "sha384-6AG7YdjBLDpReRffDoqq3EekCbNiWl7ShtEXWQPF845q+fcDjGzgqIyJ2/CF6tJJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.552.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8eEuYTAXSI9m6gmJ5Z5z8SQlFH7YfHDltJdxQjqeXcPahns5izGlpPFt1G91nFLH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.296.0/index.min.mjs": "sha384-8eEuYTAXSI9m6gmJ5Z5z8SQlFH7YfHDltJdxQjqeXcPahns5izGlpPFt1G91nFLH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.296.0/LICENSE
```

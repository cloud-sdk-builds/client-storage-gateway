...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1fvOjBAUyCVIByIxX4knLQ4qyi3bzha/vFhwD2e02E11k4NYdJuctXkWx4TZXR+C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.668.0/index.min.mjs": "sha384-1fvOjBAUyCVIByIxX4knLQ4qyi3bzha/vFhwD2e02E11k4NYdJuctXkWx4TZXR+C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.668.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LQKGm6hsLAdD+q/QlQ4OiJscEFhtFZi1hhvT9qbyeDavyYPOYJY1p5g0o0Tgg+Jr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.994.0/index.min.mjs": "sha384-LQKGm6hsLAdD+q/QlQ4OiJscEFhtFZi1hhvT9qbyeDavyYPOYJY1p5g0o0Tgg+Jr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.994.0/LICENSE
```

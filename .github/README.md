...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.76.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.76.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Dyz5z95K7yxhXiRV2/qndC1fq1+oCqplrUZnWjU8i2KQtuCizTYcnwoI+BXqQ0xN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.76.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.76.0/index.min.mjs": "sha384-Dyz5z95K7yxhXiRV2/qndC1fq1+oCqplrUZnWjU8i2KQtuCizTYcnwoI+BXqQ0xN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.76.0/LICENSE
```

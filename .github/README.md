...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FdX0iTB60h6CGa22vDz/54FsUbRdyxcpiXE/3l2XMJGCZA9PhIkXcFYLX9D6HFHn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.576.0/index.min.mjs": "sha384-FdX0iTB60h6CGa22vDz/54FsUbRdyxcpiXE/3l2XMJGCZA9PhIkXcFYLX9D6HFHn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.576.0/LICENSE
```

...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8MK8hh7SlU25ztzS5p+KlTJWpN4dR/ToGPfcFGxsL2eePA4XcTPUGA4J3qUkKgNI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.958.0/index.min.mjs": "sha384-8MK8hh7SlU25ztzS5p+KlTJWpN4dR/ToGPfcFGxsL2eePA4XcTPUGA4J3qUkKgNI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.958.0/LICENSE
```

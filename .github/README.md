...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EdNPE6B+5dEKsGY+d6lm1X/cnYE1L8qO8XgBUsklvtHnnDCabkxL0E/O5OtlhpGP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.150.0/index.min.mjs": "sha384-EdNPE6B+5dEKsGY+d6lm1X/cnYE1L8qO8XgBUsklvtHnnDCabkxL0E/O5OtlhpGP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.150.0/LICENSE
```

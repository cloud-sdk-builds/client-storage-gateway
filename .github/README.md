...
[`@aws-sdk/client-storage-gateway`](https://www.npmjs.com/package/@aws-sdk/client-storage-gateway/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1rjBg9s7oxGzdGuFLy94wAlnJQ+q4Ny6dswmiRhPYsDji7PSY2gMJRpi9ec8R93v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-storage-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-storage-gateway@3.27.0/index.min.mjs": "sha384-1rjBg9s7oxGzdGuFLy94wAlnJQ+q4Ny6dswmiRhPYsDji7PSY2gMJRpi9ec8R93v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-storage-gateway/blob/refs/tags/3.27.0/LICENSE
```
